...
public:
	...
	uint8                                         Pad_1C3B[0x8];                                     // 0x0240(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void AddMappingContextByType(const struct FInputMappingPriorityData& InputMappingPriorityData, const struct FModifyContextOptions& Options);
...
{
public:
	uint8                                         Pad_1C3E[0x28];                                    // 0x07F0(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
