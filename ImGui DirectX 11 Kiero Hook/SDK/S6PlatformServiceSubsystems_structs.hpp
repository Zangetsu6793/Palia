...
public:
	...
	uint8                                         Pad_2C1F[0x7];                                     // 0x0019(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_2C20[0x2];                                     // 0x0042(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C21[0x4];                                     // 0x004C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class FString                                 InternalCommentInfo;                               // 0x00B8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FS6PLAT_PlayerBehaviorReportForm) == 0x000008, "Wrong alignment on FS6PLAT_PlayerBehaviorReportForm");
static_assert(sizeof(FS6PLAT_PlayerBehaviorReportForm) == 0x0000C8, "Wrong size on FS6PLAT_PlayerBehaviorReportForm");
...
static_assert(offsetof(FS6PLAT_PlayerBehaviorReportForm, InternalCommentInfo) == 0x0000B8, "Member 'FS6PLAT_PlayerBehaviorReportForm::InternalCommentInfo' has a wrong offset!");
