...
bool US6UXIntentSubsystem::CanStartUXActivity(const TSoftClassPtr<class UClass>& UXIntentType)
{
	static class UFunction* Func = nullptr;
...
struct FGuid US6UXIntentSubsystem::RegisterUXActivity(const TSoftClassPtr<class UClass>& UXIntentType, const TDelegate<void(class US6UXIntentSubsystem* UXIntentSubsystem, class US6UXIntent* UXIntent)>& HandleUXIntentReceived)
{
	static class UFunction* Func = nullptr;
...
void US6UXIntentSubsystem::S6OnDifferentUXActivityRegistered__DelegateSignature(class US6UXIntentSubsystem* UXIntentSubsystem, const TSoftClassPtr<class UClass>& UXIntentType)
{
	static class UFunction* Func = nullptr;
...
void US6UXIntentSubsystem::S6OnDifferentUXActivityRegistered_Multicast__DelegateSignature(class US6UXIntentSubsystem* UXIntentSubsystem, const TSoftClassPtr<class UClass>& UXIntentType)
{
	static class UFunction* Func = nullptr;
...
void US6UXIntentSubsystem::SubscribeToUXActivityChanges(const TSoftClassPtr<class UClass>& UXIntentType, const TDelegate<void(class US6UXIntentSubsystem* UXIntentSubsystem, TSoftClassPtr<class UClass>& UXIntentType)>& HandleDifferentUXActivityRegistered)
{
	static class UFunction* Func = nullptr;
...
bool US6UXIntentSubsystem::UnregisterUXActivity(const struct FGuid& UXActivityHandle)
{
	static class UFunction* Func = nullptr;
...
void US6UXIntentSubsystem::UnsubscribeFromUXActivityChanges(const TSoftClassPtr<class UClass>& UXIntentType, const TDelegate<void(class US6UXIntentSubsystem* UXIntentSubsystem, TSoftClassPtr<class UClass>& UXIntentType)>& HandleDifferentUXActivityRegistered)
{
	static class UFunction* Func = nullptr;
