...
public:
	...
	uint8                                         Pad_2EBE[0x7];                                     // 0x0041(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2EBF[0x8];                                     // 0x0030(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	bool                                          bRunningAppendedSteps;                             // 0x0058(0x0001)(ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2EC0[0x7];                                     // 0x0059(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FS6Auto_SuiteStep>              AppendedSteps;                                     // 0x0060(0x0010)(ZeroConstructor, Transient, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	class US6Auto_SuiteBlackboard*                Blackboard;                                        // 0x0070(0x0008)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2EC1[0xD0];                                    // 0x0078(0x00D0)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	class US6Auto_SuiteStepPayload* AppendStepToCurrentSuite(const struct FS6Auto_SuiteStep& AppendedStep, TSubclassOf<class US6Auto_SuiteStepPayload> PayloadClass);
...
static_assert(sizeof(US6Auto_SuiteSubsystem) == 0x000148, "Wrong size on US6Auto_SuiteSubsystem");
...
static_assert(offsetof(US6Auto_SuiteSubsystem, bRunningAppendedSteps) == 0x000058, "Member 'US6Auto_SuiteSubsystem::bRunningAppendedSteps' has a wrong offset!");
static_assert(offsetof(US6Auto_SuiteSubsystem, AppendedSteps) == 0x000060, "Member 'US6Auto_SuiteSubsystem::AppendedSteps' has a wrong offset!");
static_assert(offsetof(US6Auto_SuiteSubsystem, Blackboard) == 0x000070, "Member 'US6Auto_SuiteSubsystem::Blackboard' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2EC2[0x20];                                    // 0x0038(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	class FString GetScriptDisplayName(const class US6Auto_SuiteStepPayload* ScriptPayload) const;
...
public:
	...
	static TArray<TSoftObjectPtr<class US6Auto_Suite>> GetSuitesFromAssetName(const class FName& SuiteAssetName);
