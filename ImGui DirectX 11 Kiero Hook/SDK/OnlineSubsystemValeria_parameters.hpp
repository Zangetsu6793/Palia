...
// 0x0020 (0x0020 - 0x0000)
struct OSSVAL_AsyncActionProfanityFilterString_FilterStringViaChat final
{
public:
	class ULocalPlayer*                           LocalPlayer;                                       // 0x0000(0x0008)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 Str;                                               // 0x0008(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(OSSVAL_AsyncActionProfanityFilterString_FilterStringViaChat) == 0x000008, "Wrong alignment on OSSVAL_AsyncActionProfanityFilterString_FilterStringViaChat");
static_assert(sizeof(OSSVAL_AsyncActionProfanityFilterString_FilterStringViaChat) == 0x000020, "Wrong size on OSSVAL_AsyncActionProfanityFilterString_FilterStringViaChat");
static_assert(offsetof(OSSVAL_AsyncActionProfanityFilterString_FilterStringViaChat, LocalPlayer) == 0x000000, "Member 'OSSVAL_AsyncActionProfanityFilterString_FilterStringViaChat::LocalPlayer' has a wrong offset!");
static_assert(offsetof(OSSVAL_AsyncActionProfanityFilterString_FilterStringViaChat, Str) == 0x000008, "Member 'OSSVAL_AsyncActionProfanityFilterString_FilterStringViaChat::Str' has a wrong offset!");
static_assert(offsetof(OSSVAL_AsyncActionProfanityFilterString_FilterStringViaChat, ReturnValue) == 0x000018, "Member 'OSSVAL_AsyncActionProfanityFilterString_FilterStringViaChat::ReturnValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1AB0[0x3];                                     // 0x000D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1AB2[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
struct ValeriaOnlineBlueprintFunctions_TryGetStagingAuthArgs final
{
public:
	class FString                                 OutEndPoint;                                       // 0x0000(0x0010)(Parm, OutParm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 OutSecretKey;                                      // 0x0010(0x0010)(Parm, OutParm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 OutAppId;                                          // 0x0020(0x0010)(Parm, OutParm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          ReturnValue;                                       // 0x0030(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1AB4[0x7];                                     // 0x0031(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(ValeriaOnlineBlueprintFunctions_TryGetStagingAuthArgs) == 0x000008, "Wrong alignment on ValeriaOnlineBlueprintFunctions_TryGetStagingAuthArgs");
static_assert(sizeof(ValeriaOnlineBlueprintFunctions_TryGetStagingAuthArgs) == 0x000038, "Wrong size on ValeriaOnlineBlueprintFunctions_TryGetStagingAuthArgs");
static_assert(offsetof(ValeriaOnlineBlueprintFunctions_TryGetStagingAuthArgs, OutEndPoint) == 0x000000, "Member 'ValeriaOnlineBlueprintFunctions_TryGetStagingAuthArgs::OutEndPoint' has a wrong offset!");
static_assert(offsetof(ValeriaOnlineBlueprintFunctions_TryGetStagingAuthArgs, OutSecretKey) == 0x000010, "Member 'ValeriaOnlineBlueprintFunctions_TryGetStagingAuthArgs::OutSecretKey' has a wrong offset!");
static_assert(offsetof(ValeriaOnlineBlueprintFunctions_TryGetStagingAuthArgs, OutAppId) == 0x000020, "Member 'ValeriaOnlineBlueprintFunctions_TryGetStagingAuthArgs::OutAppId' has a wrong offset!");
static_assert(offsetof(ValeriaOnlineBlueprintFunctions_TryGetStagingAuthArgs, ReturnValue) == 0x000030, "Member 'ValeriaOnlineBlueprintFunctions_TryGetStagingAuthArgs::ReturnValue' has a wrong offset!");
