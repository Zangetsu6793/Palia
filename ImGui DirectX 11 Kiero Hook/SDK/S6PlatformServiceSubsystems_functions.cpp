...
void US6PLAT_PlayerBehaviorSubsystem::ReportPlayerBehavior(const struct FS6PLAT_PlayerBehaviorReportForm& ReportForm)
{
	static class UFunction* Func = nullptr;
...
bool US6PLAT_PlayerBehaviorSubsystem::ValidateReportForm(const struct FS6PLAT_PlayerBehaviorReportForm& ReportForm) const
{
	static class UFunction* Func = nullptr;
