...
struct FS6AssetReleaseTargetingInfo US6AssetReleaseTargetingLibrary::GetAssetReleaseTargetingInfo_AssetData(const struct FAssetData& AssetData)
{
...
struct FS6AssetReleaseTargetingInfo US6AssetReleaseTargetingLibrary::GetAssetReleaseTargetingInfo_ObjectPath(const struct FSoftObjectPath& SoftObjectPath)
{
	static class UFunction* Func = nullptr;
...
struct FS6AssetReleaseTargetingInfo US6AssetReleaseTargetingLibrary::GetAssetReleaseTargetingInfo_PrimaryAssetId(const struct FPrimaryAssetId& AssetId)
{
	static class UFunction* Func = nullptr;
...
struct FS6AssetReleaseTargetingInfo US6AssetReleaseTargetingLibrary::GetAssetReleaseTargetingInfo_SoftObject(const TSoftObjectPtr<class UObject>& SoftObject)
{
	static class UFunction* Func = nullptr;
