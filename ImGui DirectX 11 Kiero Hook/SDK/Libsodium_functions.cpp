...
bool ULibSd_CryptoLibrary::SignMessageWithSecretKey(const TArray<uint8>& Message, const TArray<uint8>& SecretKey, TArray<uint8>* SignedMessage)
{
	static class UFunction* Func = nullptr;
...
bool ULibSd_CryptoLibrary::SignMessageWithSecretKey_Detached(const TArray<uint8>& Message, const TArray<uint8>& SecretKey, TArray<uint8>* Signature)
{
	static class UFunction* Func = nullptr;
...
bool ULibSd_CryptoLibrary::VerifyMessageWithPublicKey(const TArray<uint8>& SignedMessage, const TArray<uint8>& PublicKey, TArray<uint8>* Message)
{
	static class UFunction* Func = nullptr;
...
bool ULibSd_CryptoLibrary::VerifyMessageWithPublicKey_Detached(const TArray<uint8>& Signature, const TArray<uint8>& Message, const TArray<uint8>& PublicKey)
{
	static class UFunction* Func = nullptr;
