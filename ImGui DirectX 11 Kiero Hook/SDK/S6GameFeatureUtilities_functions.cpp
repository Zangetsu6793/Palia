...
void US6GenericAssetRegistryInstance::OnAssetsRegistered__DelegateSignature(class US6GenericAssetRegistryInstance* RegistryInstance, const TSet<TSoftObjectPtr<class UObject>>& Assets)
{
...
void US6GenericAssetRegistryInstance::OnAssetsUnregistered__DelegateSignature(class US6GenericAssetRegistryInstance* RegistryInstance, const TSet<TSoftObjectPtr<class UObject>>& Assets)
{
	static class UFunction* Func = nullptr;
...
void US6GenericAssetRegistryInstance::RegisterAssets(const TSet<TSoftObjectPtr<class UObject>>& Assets)
{
	static class UFunction* Func = nullptr;
...
void US6GenericAssetRegistryInstance::UnregisterAssets(const TSet<TSoftObjectPtr<class UObject>>& Assets)
{
	static class UFunction* Func = nullptr;
