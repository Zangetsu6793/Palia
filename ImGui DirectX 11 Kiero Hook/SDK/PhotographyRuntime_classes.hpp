...
class UVALUI_PhotoCameraScreenBase final : public US6UI_StateUserWidget
{
public:
	...
	uint8                                         Pad_32C4[0x2F];                                    // 0x0559(0x002F)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void AccumulateLookModeInput(const struct FGeometry& InGeometry, const struct FPointerEvent& InMouseEvent, bool bInvertYAxis);
	void SetLookMode(const EVALUI_PhotoCameraScreenLookMode Value);
...
public:
	...
	uint8                                         Pad_32C6[0xB0];                                    // 0x0090(0x00B0)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	bool DeleteOnlinePhoto(const struct FGuid& PhotoId);
	bool GetOnlinePhoto(const struct FGuid& AccountId, const struct FGuid& PhotoId, const TDelegate<void(class UVAL_OnlinePhotoAlbumSubsystem* OnlinePhotoAlbumSubsystem, struct FGuid& AccountId, struct FGuid& PhotoId, class UVAL_OnlinePhotograph* Photo)>& OnSucceeded, const TDelegate<void(class UVAL_OnlinePhotoAlbumSubsystem* OnlinePhotoAlbumSubsystem, struct FGuid& AccountId, struct FGuid& PhotoId, class FText& Error)>& OnFailed);
	void OnGetOnlinePhotoFailed__DelegateSignature(class UVAL_OnlinePhotoAlbumSubsystem* OnlinePhotoAlbumSubsystem, const struct FGuid& AccountId, const struct FGuid& PhotoId, const class FText& Error);
	void OnGetOnlinePhotoSucceeded__DelegateSignature(class UVAL_OnlinePhotoAlbumSubsystem* OnlinePhotoAlbumSubsystem, const struct FGuid& AccountId, const struct FGuid& PhotoId, class UVAL_OnlinePhotograph* Photo);
	void OnOnlinePhotosChanged__DelegateSignature(class UVAL_OnlinePhotoAlbumSubsystem* OnlinePhotoAlbumSubsystem, const TSet<struct FGuid>& DeletedPhotoIds, const TSet<struct FGuid>& AddedPhotoIds);
	void OnUploadPhotoFailed__DelegateSignature(class UVAL_OnlinePhotoAlbumSubsystem* OnlinePhotoAlbumSubsystem, class UVAL_CapturedPhotograph* OriginalPhotograph, const class FText& Error);
	void OnUploadPhotoSucceeded__DelegateSignature(class UVAL_OnlinePhotoAlbumSubsystem* OnlinePhotoAlbumSubsystem, class UVAL_CapturedPhotograph* OriginalPhotograph, const struct FGuid& PhotoId);
	void RefreshOurOnlinePhotos();
	bool UploadPhoto(const class UVAL_CapturedPhotograph* Photograph, const TDelegate<void(class UVAL_OnlinePhotoAlbumSubsystem* OnlinePhotoAlbumSubsystem, class UVAL_CapturedPhotograph* OriginalPhotograph, struct FGuid& PhotoId)>& OnSucceeded, const TDelegate<void(class UVAL_OnlinePhotoAlbumSubsystem* OnlinePhotoAlbumSubsystem, class UVAL_CapturedPhotograph* OriginalPhotograph, class FText& Error)>& OnFailed);

	struct FGuid GetOnlinePhotoIdForRecentPhoto(const class UVAL_CapturedPhotograph* RecentPhoto) const;
...
{
public:
	uint8                                         Pad_32CA[0x8];                                     // 0x0030(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_32CB[0x50];                                    // 0x0068(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_32CD[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_32CE[0x10];                                    // 0x0078(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
