...
class UBindingKeyListenerWidget final : public US6UI_ModalWidgetBase
{
public:
	...
	uint8                                         Pad_1D2B[0x48];                                    // 0x0568(0x0048)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void DisableInput();
	void EnableInput();
	void OnAnyKeyTriggered__DelegateSignature(const struct FKeyRebind_InputKey& InTriggeredKey);
...
class UCommonInputActionWidget final : public UUserWidget
{
public:
...
public:
	...
	void UpdateWidgetBySpecialGameplayTag(const struct FGameplayTag& GameplayTag);
...
{
public:
	uint8                                         Pad_1D2C[0x8];                                     // 0x0248(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1D2D[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
class UIARichTextBlockImageDecorator final : public UKeyRebindingRichTextBlockDecorator_KeyIcon
{
public:
	static class UClass* StaticClass()
	{
...
class UKeyRebindGroupEntryWidget final : public UUserWidget
{
public:
	...
	uint8                                         Pad_1D2E[0x6];                                     // 0x02DA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FKey>                           UnBoundKeys;                                       // 0x02E0(0x0010)(BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	class FText                                   ActionDescription;                                 // 0x02F0(0x0018)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	TWeakObjectPtr<class UKeyRebindGroupWidget>   OwnerGroup;                                        // 0x0308(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)

public:
	void BP_OnWidgetCreated();
	void InitializeRebindKey(const class UWidget* Widget, const EKeyRebind_KeySlot InSlotNum);
	void InitializeUnbindKey(const class UWidget* Widget, const EKeyRebind_KeySlot InSlotNum);
	void InitKeyRebindEntryDesc();
	bool IsInputActionMatched(const class UInputAction* InputAction);
	void OnIconRefreshed(const TArray<struct FInputKeysIcon>& RefreshIcons);
	void RefreshIcon();
...
static_assert(sizeof(UKeyRebindGroupEntryWidget) == 0x000310, "Wrong size on UKeyRebindGroupEntryWidget");
...
static_assert(offsetof(UKeyRebindGroupEntryWidget, ActionDescription) == 0x0002F0, "Member 'UKeyRebindGroupEntryWidget::ActionDescription' has a wrong offset!");
static_assert(offsetof(UKeyRebindGroupEntryWidget, OwnerGroup) == 0x000308, "Member 'UKeyRebindGroupEntryWidget::OwnerGroup' has a wrong offset!");

// Class KeyRebinding.KeyRebindGroupWidget
// 0x0048 (0x0308 - 0x02C0)
class UKeyRebindGroupWidget final : public UUserWidget
{
public:
	...
	uint8                                         Pad_1D32[0x7];                                     // 0x02C9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D33[0x4];                                     // 0x02EC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	void BP_OnWidgetCreated();
	bool IsEqualGroup(const int32 InGroup);
...
// Class KeyRebinding.KeyRebindingGroupDataAsset
// 0x0010 (0x0040 - 0x0030)
class UKeyRebindingGroupDataAsset final : public UDataAsset
{
public:
	TArray<struct FKeyRebind_GroupData>           Groups;                                            // 0x0030(0x0010)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)

public:
	const TArray<struct FKeyRebind_GroupData> GetGroups() const;

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"KeyRebindingGroupDataAsset">();
	}
	static class UKeyRebindingGroupDataAsset* GetDefaultObj()
	{
		return GetDefaultObjImpl<UKeyRebindingGroupDataAsset>();
	}
};
static_assert(alignof(UKeyRebindingGroupDataAsset) == 0x000008, "Wrong alignment on UKeyRebindingGroupDataAsset");
static_assert(sizeof(UKeyRebindingGroupDataAsset) == 0x000040, "Wrong size on UKeyRebindingGroupDataAsset");
static_assert(offsetof(UKeyRebindingGroupDataAsset, Groups) == 0x000030, "Member 'UKeyRebindingGroupDataAsset::Groups' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1D35[0x3];                                     // 0x0035(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D36[0x4];                                     // 0x0064(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	class UKeyRebindingGroupDataAsset*            GroupDataAsset;                                    // 0x0078(0x0008)(Edit, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TArray<class UKeyRebindValidatorBase*>        GlobalValidators;                                  // 0x0080(0x0010)(Edit, ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<struct FKey>                           UnBoundKeys;                                       // 0x0090(0x0010)(Edit, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
static_assert(offsetof(UKeyRebindingDataset, GroupDataAsset) == 0x000078, "Member 'UKeyRebindingDataset::GroupDataAsset' has a wrong offset!");
static_assert(offsetof(UKeyRebindingDataset, GlobalValidators) == 0x000080, "Member 'UKeyRebindingDataset::GlobalValidators' has a wrong offset!");
static_assert(offsetof(UKeyRebindingDataset, UnBoundKeys) == 0x000090, "Member 'UKeyRebindingDataset::UnBoundKeys' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1D37[0x4];                                     // 0x0064(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1D38[0x50];                                    // 0x00B0(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class UInputMappingContext*, class UInputMappingContext*> CacheRemappingIMCs;                                // 0x0100(0x0050)(Transient, NativeAccessSpecifierPrivate)
	class UObject*                                CustomKeyMappingDataProvider;                      // 0x0150(0x0008)(ZeroConstructor, Transient, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPrivate)

public:
	void ApplyCustomKeyMappings();
	bool AttemptRebinding(const class UInputAction* InputAction, const EKeyRebind_KeySlot Slot, const struct FKeyRebind_InputKey& Keys, const ECommonInputType InputType, struct FKeyRebind_BindingResult* OutResult);
	bool AttemptUnbinding(const class UInputAction* InputAction, const EKeyRebind_KeySlot Slot, const ECommonInputType InputType, struct FKeyRebind_UnbindingResult* OutResult);
	void KeyRebindingResultDelegate__DelegateSignature(const ECommonInputType InputType, const struct FKeyRebind_BindingResult& BindingResult);
	void KeyUnbindingResultDelegate__DelegateSignature(const ECommonInputType InputType, const struct FKeyRebind_UnbindingResult& UnbindingResult);
	void ResetToDefaultMappings(const ECommonInputType InputType, const bool bEffectImmediately);
	void SimpleKeyRebindingSystemDelegate__DelegateSignature(const ECommonInputType InputType);

	void GetInputActionKeys(const class UInputAction* InputAction, const ECommonInputType InputType, TArray<struct FKeyRebind_InputKey>* OutKeys) const;
	TArray<struct FKeyRebind_KeyMappingEntry> GetRebindings(const ECommonInputType InputType) const;
...
static_assert(sizeof(UKeyRebindingSubsystem) == 0x000158, "Wrong size on UKeyRebindingSubsystem");
...
static_assert(offsetof(UKeyRebindingSubsystem, CacheRemappingIMCs) == 0x000100, "Member 'UKeyRebindingSubsystem::CacheRemappingIMCs' has a wrong offset!");
static_assert(offsetof(UKeyRebindingSubsystem, CustomKeyMappingDataProvider) == 0x000150, "Member 'UKeyRebindingSubsystem::CustomKeyMappingDataProvider' has a wrong offset!");
...
{
public:
	static const class UCommonInputSubsystem* GetCommonInputSystem(const class UObject* WorldContextObject);
	static class UEnhancedInputSubsystemWithKeyRebinding* GetEnhancedInputSubsystem(const class UObject* WorldContextObject);
	static bool GetIconForEnhancedInputAction(const class UObject* WorldContextObject, const class UInputAction* InputAction, const ECommonInputType InputType, const struct FGameplayTag& SpecialTag, struct FSlateBrush* OutMainKeyBrush, struct FSlateBrush* OutChordKeyBrush);
	static bool GetInputType(const class FName IMCInputTypeIdentification, const struct FKey& TestKey, ECommonInputType* OutInputTyp);
	static bool GetKeyIcons(const class UObject* WorldContextObject, const struct FInputKeys& InputKeys, const ECommonInputType InputType, const struct FGameplayTag& SpecialTag, struct FSlateBrush* OutMainKeyBrush, struct FSlateBrush* OutChordKeyBrush);
	static bool GetKeyIconsWithIMC(const class UObject* WorldContextObject, const class UInputMappingContext* MappingContext, const class UInputAction* InputAction, const ECommonInputType InputType, const struct FGameplayTag& SpecialTag, struct FSlateBrush* OutMainKeyBrush, struct FSlateBrush* OutChordKeyBrush);
	static class FText GetKeyName(const struct FKey& Key);
	static class UKeyRebindingSubsystem* GetKeyRebindingSystem(const class UObject* WorldContextObject);
	static bool GetKeysForEnhancedInputAction(const class UObject* WorldContextObject, const class UInputAction* InputAction, const ECommonInputType InputType, struct FInputKeys* OutKeys);
	static const class ULocalPlayer* GetLocalPlayer(const class UObject* WorldContextObject);
	static float GetPromptDelayTime();
	static bool IsMatchingInputType(const ECommonInputType InputType, const struct FKey& TestKey);
...
class UKeyRebindSettingsWidgetBase final : public UCommonActivatableWidgetInputExtended
{
public:
	...
	uint8                                         Pad_1D50[0x7];                                     // 0x0521(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D51[0x7];                                     // 0x0539(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D52[0x8];                                     // 0x0550(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void ApplyCustomConfig();
	void BP_OnSubWidgetInitCompleted();
	void CreateKeyRebindGroupWidget(const TArray<struct FKeyRebind_KeyMappingEntry>& InKeyRebindInfo);
	void InitializeRebindKey(const class UWidget* Widget, const class UInputAction* InInputAction, EKeyRebind_KeySlot InSlotNum);
	void InitializeUnbindKey(const class UWidget* Widget, const class UInputAction* InInputAction, EKeyRebind_KeySlot InSlotNum);
	void OnAnyKeyTriggered(const struct FKeyRebind_InputKey& InInputKeys);
	void OnKeyRebindBegin(const class UWidget* Widget, const bool bIsRebinding);
	void OnKeyRebindEnd(const struct FKeyRebind_DisplayResult& ResultInfo, const bool bIsRebinding);
	void RefreshSubWidget(const struct FKeyRebind_DisplayResult& ResultInfo, bool bRefreshAll);
	void ResetToDefaultConfig();

	class FText GetDescriptionofInputAction(const class UInputAction* InInputAction) const;
...
{
public:
	EKeyRebindValidationResult TestRebindingValidation(const class UKeyRebindingSubsystem* KeyRebindingSubsystem, const struct FKeyRebindValidator_RebindParamters& RebindParamters, TArray<class FText>* OutErrorMessages) const;
	EKeyRebindValidationResult TestUnbindingValidation(const class UKeyRebindingSubsystem* KeyRebindingSubsystem, const struct FKeyRebindValidator_UnbindParamters& UnbindParamters, TArray<class FText>* OutErrorMessages) const;
...
// Class KeyRebinding.KeyRebindValidator_FilterSpecialIAs
// 0x0040 (0x0068 - 0x0028)
class UKeyRebindValidator_FilterSpecialIAs final : public UKeyRebindValidatorBase
{
public:
	EKeyRebindValidator_FilterSpecialIAType       FilterType;                                        // 0x0028(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_1D5A[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UInputAction*>                   TargetIAs;                                         // 0x0030(0x0010)(Edit, ZeroConstructor, Protected, UObjectWrapper, NativeAccessSpecifierProtected)
	TArray<int32>                                 SpeicalGroupIds;                                   // 0x0040(0x0010)(Edit, ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FKeyRebind_KeyMappingEntry>     TargetIAInfos;                                     // 0x0050(0x0010)(ZeroConstructor, Transient, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_1D5B[0x8];                                     // 0x0060(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void K2_TestRebindingFailed(const class UInputAction* ConflictIA, TArray<class FText>* OutErrorMessages) const;

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"KeyRebindValidator_FilterSpecialIAs">();
	}
	static class UKeyRebindValidator_FilterSpecialIAs* GetDefaultObj()
	{
		return GetDefaultObjImpl<UKeyRebindValidator_FilterSpecialIAs>();
	}
};
static_assert(alignof(UKeyRebindValidator_FilterSpecialIAs) == 0x000008, "Wrong alignment on UKeyRebindValidator_FilterSpecialIAs");
static_assert(sizeof(UKeyRebindValidator_FilterSpecialIAs) == 0x000068, "Wrong size on UKeyRebindValidator_FilterSpecialIAs");
static_assert(offsetof(UKeyRebindValidator_FilterSpecialIAs, FilterType) == 0x000028, "Member 'UKeyRebindValidator_FilterSpecialIAs::FilterType' has a wrong offset!");
static_assert(offsetof(UKeyRebindValidator_FilterSpecialIAs, TargetIAs) == 0x000030, "Member 'UKeyRebindValidator_FilterSpecialIAs::TargetIAs' has a wrong offset!");
static_assert(offsetof(UKeyRebindValidator_FilterSpecialIAs, SpeicalGroupIds) == 0x000040, "Member 'UKeyRebindValidator_FilterSpecialIAs::SpeicalGroupIds' has a wrong offset!");
static_assert(offsetof(UKeyRebindValidator_FilterSpecialIAs, TargetIAInfos) == 0x000050, "Member 'UKeyRebindValidator_FilterSpecialIAs::TargetIAInfos' has a wrong offset!");
