...
// Enum ValeriaUI.EVALUI_PremiumStoreTabType
// NumValues: 0x0005
enum class EVALUI_PremiumStoreTabType : uint8
{
	Featured                                 = 0,
	Bundle                                   = 1,
	ItemType                                 = 2,
...
{
public:
	uint8                                         Pad_2C26[0x1];                                     // 0x0000(0x0001)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_2C27[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSet<TSoftObjectPtr<class UVAL_PremiumItemAsset>> Items;                                             // 0x0030(0x0050)(BlueprintVisible, UObjectWrapper, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_2C28[0x7];                                     // 0x00D1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSet<TSubclassOf<class UVAL_PremiumItemAsset>> Classes;                                           // 0x00D8(0x0050)(BlueprintVisible, BlueprintReadOnly, UObjectWrapper, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVALUI_PremiumStorefrontVariant) == 0x000008, "Wrong alignment on FVALUI_PremiumStorefrontVariant");
static_assert(sizeof(FVALUI_PremiumStorefrontVariant) == 0x000128, "Wrong size on FVALUI_PremiumStorefrontVariant");
...
static_assert(offsetof(FVALUI_PremiumStorefrontVariant, Classes) == 0x0000D8, "Member 'FVALUI_PremiumStorefrontVariant::Classes' has a wrong offset!");
...
public:
	...
	int32                                         BasePrice;                                         // 0x0024(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          Owned;                                             // 0x0028(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C29[0x7];                                     // 0x0029(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	EVALUI_PremiumStoreTabType                    TabType;                                           // 0x0051(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C2A[0x6];                                     // 0x0052(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	TSet<TSubclassOf<class UVAL_PremiumItemAsset>> VariantClasses;                                    // 0x0058(0x0050)(BlueprintVisible, BlueprintReadOnly, UObjectWrapper, NativeAccessSpecifierPublic)
	class FString                                 BannerText;                                        // 0x00A8(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDateTime                              StartTime;                                         // 0x00B8(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FDateTime                              EndTime;                                           // 0x00C0(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         Discount;                                          // 0x00C8(0x0004)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C2B[0x4];                                     // 0x00CC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(FVALUI_PremiumStorefrontWidgetModel) == 0x0000D0, "Wrong size on FVALUI_PremiumStorefrontWidgetModel");
...
static_assert(offsetof(FVALUI_PremiumStorefrontWidgetModel, TabType) == 0x000051, "Member 'FVALUI_PremiumStorefrontWidgetModel::TabType' has a wrong offset!");
static_assert(offsetof(FVALUI_PremiumStorefrontWidgetModel, VariantClasses) == 0x000058, "Member 'FVALUI_PremiumStorefrontWidgetModel::VariantClasses' has a wrong offset!");
static_assert(offsetof(FVALUI_PremiumStorefrontWidgetModel, BannerText) == 0x0000A8, "Member 'FVALUI_PremiumStorefrontWidgetModel::BannerText' has a wrong offset!");
static_assert(offsetof(FVALUI_PremiumStorefrontWidgetModel, StartTime) == 0x0000B8, "Member 'FVALUI_PremiumStorefrontWidgetModel::StartTime' has a wrong offset!");
static_assert(offsetof(FVALUI_PremiumStorefrontWidgetModel, EndTime) == 0x0000C0, "Member 'FVALUI_PremiumStorefrontWidgetModel::EndTime' has a wrong offset!");
static_assert(offsetof(FVALUI_PremiumStorefrontWidgetModel, Discount) == 0x0000C8, "Member 'FVALUI_PremiumStorefrontWidgetModel::Discount' has a wrong offset!");
...
{
public:
	struct FVALUI_PremiumStorefrontVariant        Variant;                                           // 0x0000(0x0128)(BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FVALUI_PremiumStorefrontWidgetModel    ParentSet;                                         // 0x0128(0x00D0)(BlueprintVisible, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(FVALUI_PremiumStorefrontMultipleVariantsDataHelper) == 0x0001F8, "Wrong size on FVALUI_PremiumStorefrontMultipleVariantsDataHelper");
...
static_assert(offsetof(FVALUI_PremiumStorefrontMultipleVariantsDataHelper, ParentSet) == 0x000128, "Member 'FVALUI_PremiumStorefrontMultipleVariantsDataHelper::ParentSet' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2C2E[0x3];                                     // 0x0001(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2C2F[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2C31[0x6];                                     // 0x003A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2C32[0x2];                                     // 0x0006(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2C33[0x4];                                     // 0x001C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_2C34[0x7];                                     // 0x0099(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C35[0x3];                                     // 0x00D9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C36[0x7];                                     // 0x00F1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C37[0x7];                                     // 0x0129(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
// ScriptStruct ValeriaUI.VALUI_BorderedTextStyleInfo
// 0x0048 (0x0048 - 0x0000)
struct FVALUI_BorderedTextStyleInfo final
{
public:
	TSoftObjectPtr<class UVALUI_BorderStyle>      Border;                                            // 0x0000(0x0028)(Edit, BlueprintVisible, BlueprintReadOnly, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           RecommendedTextColor;                              // 0x0028(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FLinearColor                           RecommendedTextOutlineColor;                       // 0x0038(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVALUI_BorderedTextStyleInfo) == 0x000008, "Wrong alignment on FVALUI_BorderedTextStyleInfo");
static_assert(sizeof(FVALUI_BorderedTextStyleInfo) == 0x000048, "Wrong size on FVALUI_BorderedTextStyleInfo");
static_assert(offsetof(FVALUI_BorderedTextStyleInfo, Border) == 0x000000, "Member 'FVALUI_BorderedTextStyleInfo::Border' has a wrong offset!");
static_assert(offsetof(FVALUI_BorderedTextStyleInfo, RecommendedTextColor) == 0x000028, "Member 'FVALUI_BorderedTextStyleInfo::RecommendedTextColor' has a wrong offset!");
static_assert(offsetof(FVALUI_BorderedTextStyleInfo, RecommendedTextOutlineColor) == 0x000038, "Member 'FVALUI_BorderedTextStyleInfo::RecommendedTextOutlineColor' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2C38[0x7];                                     // 0x0031(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_2C39[0x4];                                     // 0x0054(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_2C3A[0x4];                                     // 0x001C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
// ScriptStruct ValeriaUI.VALUI_PremiumStoreTabPayload
// 0x0058 (0x0058 - 0x0000)
struct FVALUI_PremiumStoreTabPayload final
{
public:
	EVALUI_PremiumStoreTabType                    TabType;                                           // 0x0000(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C3B[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSet<TSubclassOf<class UVAL_PremiumItemAsset>> ItemSubclasses;                                    // 0x0008(0x0050)(Edit, BlueprintVisible, UObjectWrapper, NativeAccessSpecifierPublic)
};
static_assert(alignof(FVALUI_PremiumStoreTabPayload) == 0x000008, "Wrong alignment on FVALUI_PremiumStoreTabPayload");
static_assert(sizeof(FVALUI_PremiumStoreTabPayload) == 0x000058, "Wrong size on FVALUI_PremiumStoreTabPayload");
static_assert(offsetof(FVALUI_PremiumStoreTabPayload, TabType) == 0x000000, "Member 'FVALUI_PremiumStoreTabPayload::TabType' has a wrong offset!");
static_assert(offsetof(FVALUI_PremiumStoreTabPayload, ItemSubclasses) == 0x000008, "Member 'FVALUI_PremiumStoreTabPayload::ItemSubclasses' has a wrong offset!");
