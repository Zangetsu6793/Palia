...
// Parameters:
// struct FS6Auto_SuiteStep                AppendedStep                                           (Parm, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
// TSubclassOf<class US6Auto_SuiteStepPayload>PayloadClass                                           (Parm, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class US6Auto_SuiteStepPayload*         ReturnValue                                            (Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

class US6Auto_SuiteStepPayload* US6Auto_SuiteSubsystem::AppendStepToCurrentSuite(const struct FS6Auto_SuiteStep& AppendedStep, TSubclassOf<class US6Auto_SuiteStepPayload> PayloadClass)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("S6Auto_SuiteSubsystem", "AppendStepToCurrentSuite");

	Params::S6Auto_SuiteSubsystem_AppendStepToCurrentSuite Parms{};

	Parms.AppendedStep = std::move(AppendedStep);
	Parms.PayloadClass = PayloadClass;
...
class FString US6Auto_SuiteStepScript::GetScriptDisplayName(const class US6Auto_SuiteStepPayload* ScriptPayload) const
{
	static class UFunction* Func = nullptr;
...
TArray<TSoftObjectPtr<class US6Auto_Suite>> US6AutoStatics::GetSuitesFromAssetName(const class FName& SuiteAssetName)
{
	static class UFunction* Func = nullptr;
