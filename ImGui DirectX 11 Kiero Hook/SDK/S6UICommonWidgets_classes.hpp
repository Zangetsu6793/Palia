...
{
public:
	uint8                                         Pad_2C0A[0x8];                                     // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2C0B[0xF];                                     // 0x02C1(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C0C[0x10];                                    // 0x03D0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
class US6UI_CommonButtonStyle final : public UCommonButtonStyle
{
public:
	...
	uint8                                         Pad_2C0D[0x3];                                     // 0x07B1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2C0E[0x4];                                     // 0x068C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C0F[0x28];                                    // 0x06D8(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
class US6UI_CommonButton_Styled final : public UCommonButtonBase
{
public:
	...
	uint8                                         Pad_2C10[0xF];                                     // 0x1561(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void SetCommonButtonStyle(TSubclassOf<class US6UI_CommonButtonStyle> InStyle);
	void SetIsDropShadow(const bool bEnable);
	void ToggleRootButtonFocuseState(const bool bEnable);
...
public:
	...
	uint8                                         Pad_2C11[0x3];                                     // 0x01D1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C12[0x3];                                     // 0x01E1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C13[0x6];                                     // 0x01F2(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C14[0xF];                                     // 0x0231(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C15[0x20];                                    // 0x0830(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void InsertTextAtCursor(const class FText& InText);
	void PasteTextFromClipboard();
	void Redo();
	void S6UI_OnEditableTextChangedEvent__DelegateSignature(const class FText& Param_Text);
	void S6UI_OnEditableTextCommittedEvent__DelegateSignature(const class FText& Param_Text, ETextCommit CommitMethod);
	void SelectAllText();
	...
	void SetDefaultTextStyle(const struct FEditableTextStyle& InDefaultTextStyle);
...
class US6UI_EditableRichTextDecorator_Image final : public US6UI_EditableRichTextDecorator
{
public:
...
// 0x0000 (0x0028 - 0x0028)
class US6UI_EditableRichTextDecorator_Style final : public US6UI_EditableRichTextDecorator
{
public:
	static class UClass* StaticClass()
	{
...
public:
	...
	uint8                                         Pad_2C18[0x4];                                     // 0x01DC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2C19[0x10];                                    // 0x0058(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2C1A[0x28];                                    // 0x0198(0x0028)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C1B[0x1C];                                    // 0x01C4(0x001C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
class US6UI_RichTextBlockDecorator_SoftImage final : public URichTextBlockDecorator
{
public:
	TSoftObjectPtr<class UDataTable>              ImageSet;                                          // 0x0028(0x0028)(Edit, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class USlateBrushAsset*                       ImageBrushAsset;                                   // 0x0050(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
// 0x0000 (0x0028 - 0x0028)
class US6UI_RichTextBlockDecorator_Style final : public URichTextBlockDecorator
{
public:
	static class UClass* StaticClass()
	{
...
class US6UI_RichTextBlockDecorator_URL final : public URichTextBlockDecorator
{
public:
