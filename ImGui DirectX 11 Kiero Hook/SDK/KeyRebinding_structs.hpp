...
// Enum KeyRebinding.EKeyRebindValidator_FilterSpecialIAType
// NumValues: 0x0003
enum class EKeyRebindValidator_FilterSpecialIAType : uint8
{
	SpecialIAs                               = 0,
	SpecialGroup                             = 1,
	EKeyRebindValidator_MAX                  = 2,
};
...
public:
	...
	int32                                         RebindGroup;                                       // 0x0008(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         RebindIdentifier;                                  // 0x000C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_1D1A[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(offsetof(FKeyRebind_KeyMappingEntry, RebindGroup) == 0x000008, "Member 'FKeyRebind_KeyMappingEntry::RebindGroup' has a wrong offset!");
static_assert(offsetof(FKeyRebind_KeyMappingEntry, RebindIdentifier) == 0x00000C, "Member 'FKeyRebind_KeyMappingEntry::RebindIdentifier' has a wrong offset!");
...
{
public:
	uint8                                         Pad_1D1B[0x8];                                     // 0x0000(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1D1C[0x6];                                     // 0x000A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1D1E[0x7];                                     // 0x0011(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D1F[0x7];                                     // 0x0059(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1D20[0x3];                                     // 0x0005(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
// ScriptStruct KeyRebinding.KeyRebind_GroupData
// 0x0020 (0x0020 - 0x0000)
struct FKeyRebind_GroupData final
{
public:
	...
	uint8                                         Pad_1D21[0x4];                                     // 0x0004(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   GroupName;                                         // 0x0008(0x0018)(Edit, NativeAccessSpecifierPublic)
};
static_assert(alignof(FKeyRebind_GroupData) == 0x000008, "Wrong alignment on FKeyRebind_GroupData");
static_assert(sizeof(FKeyRebind_GroupData) == 0x000020, "Wrong size on FKeyRebind_GroupData");
static_assert(offsetof(FKeyRebind_GroupData, GroupID) == 0x000000, "Member 'FKeyRebind_GroupData::GroupID' has a wrong offset!");
static_assert(offsetof(FKeyRebind_GroupData, GroupName) == 0x000008, "Member 'FKeyRebind_GroupData::GroupName' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1D22[0x7];                                     // 0x0031(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1D23[0x6];                                     // 0x0002(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1D25[0x4];                                     // 0x002C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1D26[0x7];                                     // 0x0031(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
// ScriptStruct KeyRebinding.KeyRebindValidator_RebindParamters
// 0x0048 (0x0048 - 0x0000)
struct FKeyRebindValidator_RebindParamters final
{
public:
	ECommonInputType                              InputType;                                         // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1D27[0x7];                                     // 0x0001(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	class UInputAction*                           InputAction;                                       // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         RebindGroup;                                       // 0x0010(0x0004)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EKeyRebind_KeySlot                            Slot;                                              // 0x0014(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1D28[0x3];                                     // 0x0015(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	struct FKeyRebind_InputKey                    InputKeys;                                         // 0x0018(0x0030)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
};
static_assert(alignof(FKeyRebindValidator_RebindParamters) == 0x000008, "Wrong alignment on FKeyRebindValidator_RebindParamters");
static_assert(sizeof(FKeyRebindValidator_RebindParamters) == 0x000048, "Wrong size on FKeyRebindValidator_RebindParamters");
static_assert(offsetof(FKeyRebindValidator_RebindParamters, InputType) == 0x000000, "Member 'FKeyRebindValidator_RebindParamters::InputType' has a wrong offset!");
static_assert(offsetof(FKeyRebindValidator_RebindParamters, InputAction) == 0x000008, "Member 'FKeyRebindValidator_RebindParamters::InputAction' has a wrong offset!");
static_assert(offsetof(FKeyRebindValidator_RebindParamters, RebindGroup) == 0x000010, "Member 'FKeyRebindValidator_RebindParamters::RebindGroup' has a wrong offset!");
static_assert(offsetof(FKeyRebindValidator_RebindParamters, Slot) == 0x000014, "Member 'FKeyRebindValidator_RebindParamters::Slot' has a wrong offset!");
static_assert(offsetof(FKeyRebindValidator_RebindParamters, InputKeys) == 0x000018, "Member 'FKeyRebindValidator_RebindParamters::InputKeys' has a wrong offset!");

// ScriptStruct KeyRebinding.KeyRebindValidator_UnbindParamters
// 0x0018 (0x0018 - 0x0000)
struct FKeyRebindValidator_UnbindParamters final
{
public:
	ECommonInputType                              InputType;                                         // 0x0000(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class UInputAction*                           InputAction;                                       // 0x0008(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EKeyRebind_KeySlot                            Slot;                                              // 0x0010(0x0001)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1D2A[0x7];                                     // 0x0011(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FKeyRebindValidator_UnbindParamters) == 0x000008, "Wrong alignment on FKeyRebindValidator_UnbindParamters");
static_assert(sizeof(FKeyRebindValidator_UnbindParamters) == 0x000018, "Wrong size on FKeyRebindValidator_UnbindParamters");
static_assert(offsetof(FKeyRebindValidator_UnbindParamters, InputType) == 0x000000, "Member 'FKeyRebindValidator_UnbindParamters::InputType' has a wrong offset!");
static_assert(offsetof(FKeyRebindValidator_UnbindParamters, InputAction) == 0x000008, "Member 'FKeyRebindValidator_UnbindParamters::InputAction' has a wrong offset!");
static_assert(offsetof(FKeyRebindValidator_UnbindParamters, Slot) == 0x000010, "Member 'FKeyRebindValidator_UnbindParamters::Slot' has a wrong offset!");
