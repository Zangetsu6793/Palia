...
public:
	void CenterBodyText();
	void Construct();
	void ExecuteUbergraph_WBP_BasicTooltip(int32 EntryPoint);
	void HandleOnClosed();
	void HandleOnOpening();
	void PlayTooltipAnimation();
	void Reset();
	void UpdateFullTooltip(const class FText& Text, class UTexture2D* Image, const class FText& Header);
	void UpdateHeader(const class FText& Header);
	void UpdateImage(class UTexture2D* Image);
	void UpdateText(const class FText& Param_ToolTipText);
