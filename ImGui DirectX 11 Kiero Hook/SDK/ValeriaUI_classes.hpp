...
class UVALUI_EmoteButtonContainer final : public UUserWidget
{
public:
...
public:
	...
	void OnEmoteButtonClicked(class UVALUI_EmoteButton* InButtonClicked, const class UEmoteDataAsset* InEmoteDataAsset);
	void OnEmoteContainerButtonClicked__DelegateSignature(class UVALUI_EmoteButtonContainer* Container, class UVALUI_EmoteButton* ButtonClicked, const class UEmoteDataAsset* EmoteDataAsset);
...
{
public:
	uint8                                         Pad_2C3C[0x8];                                     // 0x0C70(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C3D[0x6];                                     // 0x0C82(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C3E[0x10];                                    // 0x0CB8(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	void OnListItemsChanged__DelegateSignature(const TArray<class UObject*>& AddedItems, const TArray<class UObject*>& RemovedItems);
	...
	void ResetPoolAndSetListItems(const TArray<class UObject*>& InListItems);
	...
	TArray<class UObject*> GetItemsWithinRange(const int32& StartingIndex, const int32& Range) const;
...
public:
	...
	uint8                                         Pad_2C40[0x1E];                                    // 0x0CE2(0x001E)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
class UMainLobbyBase final : public UCommonActivatableWidgetInputExtended
{
public:
	void HandleInitialSteamLoginFailure(const int32 Code, const class FString& Msg);
	void OnSteamInitializationFailure();
	void OnSteamLoginError(const class FText& Msg);
...
public:
	...
	uint8                                         Pad_2C42[0x8];                                     // 0x05C8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2C43[0x30];                                    // 0x02E0(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	bool UpdateDetail(const TSoftObjectPtr<class UVAL_ItemTypeDefinitionAsset>& ItemType);
...
public:
	...
	uint8                                         Pad_2C45[0x7];                                     // 0x0049(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
class UVALUI_LobbyScreenUserWidget final : public US6UI_InputActionHandlingUserWidget
{
public:
...
public:
	...
	uint8                                         Pad_2C46[0x4];                                     // 0x055C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
// 0x0000 (0x0510 - 0x0510)
class UHeadlessSteamAccountFlowBase final : public UCommonActivatableWidgetInputExtended
{
public:
	void BindDelegates();
	class FString GetErrorMessageFromResponse(const class FString& Response);
	bool IsErrorRetriable(const int32 Code, const class FString& Message);
	class FText LoginErrorMessage(const int32 Code, const class FString& Message);
	...
	class FText RegistrationErrorMessage(const int32 Code, const class FString& Message);
...
// 0x0000 (0x0510 - 0x0510)
class ULinkSteamAccountFlowBase final : public UCommonActivatableWidgetInputExtended
{
public:
	void BindDelegates();
	class FString GetErrorMessageFromResponse(const class FString& Response);
	class FText LinkErrorMessage(const int32 Code, const class FString& Message);
...
public:
	...
	uint8                                         Pad_2C55[0x38];                                    // 0x02D0(0x0038)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void HandleOnPawnChanged(class APawn* Pawn);
	void HandleSetBackgroundImage(class UTexture2D* Texture);
	void HandleSetLoadingScreenTip(const struct FPaliaLoadingScreenTip& Tip);
...
public:
	...
	uint8                                         Pad_2C56[0x7];                                     // 0x0559(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C57[0x7];                                     // 0x0571(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2C5F[0x50];                                    // 0x03F0(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C60[0x8];                                     // 0x0448(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
class UVALUI_AnnouncementsMessageModalDialog final : public UVALUI_ModalWidgetBase
{
public:
	...
	uint8                                         Pad_2C61[0x7];                                     // 0x0559(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2C62[0x8];                                     // 0x0050(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2C63[0xCB8];                                   // 0x0050(0x0CB8)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UVALUI_AsyncUpdateLoadout* UpdateLoadout(class UVALUI_CharacterCustomizationPanelBase* CustPanel, const struct FVAL_CharacterCustomizationLoadout& NewLoadout, const struct FVALUI_CharCustomization_UpdateLoadoutContextPayload& ContextPayload);

	void OnUpdateLoadoutFailed__DelegateSignature(const struct FVALUI_CharCustomization_UpdateLoadoutContextPayload& ContextPayload);
...
static_assert(sizeof(UVALUI_AsyncUpdateLoadout) == 0x000D08, "Wrong size on UVALUI_AsyncUpdateLoadout");
...
// Class ValeriaUI.VALUI_BorderedTextStyleSet
// 0x0050 (0x0080 - 0x0030)
class UVALUI_BorderedTextStyleSet final : public UDataAsset
{
public:
	TMap<class FName, struct FVALUI_BorderedTextStyleInfo> Borders;                                           // 0x0030(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"VALUI_BorderedTextStyleSet">();
	}
	static class UVALUI_BorderedTextStyleSet* GetDefaultObj()
	{
		return GetDefaultObjImpl<UVALUI_BorderedTextStyleSet>();
	}
};
static_assert(alignof(UVALUI_BorderedTextStyleSet) == 0x000008, "Wrong alignment on UVALUI_BorderedTextStyleSet");
static_assert(sizeof(UVALUI_BorderedTextStyleSet) == 0x000080, "Wrong size on UVALUI_BorderedTextStyleSet");
static_assert(offsetof(UVALUI_BorderedTextStyleSet, Borders) == 0x000030, "Member 'UVALUI_BorderedTextStyleSet::Borders' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2C64[0x3];                                     // 0x0031(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C65[0xC];                                     // 0x0054(0x000C)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C66[0xF];                                     // 0x02E1(0x000F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2C67[0x6];                                     // 0x033A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C68[0x18];                                    // 0x0398(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void OnAccessbilitySettingsChanged(const struct FValeriaAccessibilitySettings& AccessbilitySettings);
...
class UVALUI_BoundInputActionStateWidget final : public UUserWidget
{
public:
	...
	uint8                                         Pad_2C69[0x50];                                    // 0x02C8(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void SetInputAction(class UInputAction* InInputAction);
	void UpdateInputActionState_Implementation(const struct FKey& Key, const ETriggerEvent LatestTriggerEvent, const float OngoingDuration, const float HoldTimeThreshold);
...
public:
	...
	uint8                                         Pad_2C6C[0x10];                                    // 0x01C0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2C6D[0x4];                                     // 0x0444(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2C6E[0xF];                                     // 0x0491(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C6F[0xF];                                     // 0x0571(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2C70[0x3];                                     // 0x0621(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C71[0x38];                                    // 0x0628(0x0038)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C72[0x1E];                                    // 0x0662(0x001E)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2C74[0x10];                                    // 0x0680(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C75[0x7];                                     // 0x0761(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C76[0xD8];                                    // 0x0778(0x00D8)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C77[0x4F];                                    // 0x0851(0x004F)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
class UVALUI_NameValidator_Regex_PerWord final : public UVALUI_NameValidator_Regex
{
public:
	static class UClass* StaticClass()
	{
...
class UVALUI_CharacterCreationScreenBase final : public UCommonActivatableWidgetInputExtended
{
public:
...
public:
	void HandleCharacterNameChanged(const class FText& InCharacterName, const EVAL_CharacterNameType InCharacterNameType);
	void HandleCharacterNameValidityResponse(const struct FVALUI_CharacterNameValidityResponse& Response);
...
{
public:
	static bool IsCharacterNameValidityResponseValid(const struct FVALUI_CharacterNameValidityResponse& Response);
...
// 0x0D10 (0x1220 - 0x0510)
class UVALUI_CharacterCustomizationPanelBase final : public UCommonActivatableWidgetInputExtended
{
public:
	uint8                                         Pad_2C7B[0x10];                                    // 0x0510(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FVAL_CharacterCustomizationLoadout     CurrentLoadout;                                    // 0x0530(0x0C48)(BlueprintVisible, Protected, NativeAccessSpecifierProtected)
	TMap<class FName, struct FVALUI_CharCustomization_LoadoutSlotData> LoadoutSlotMap;                                    // 0x1178(0x0050)(Edit, BlueprintVisible, Transient, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	class UEnum*                                  ItemTypeEnum;                                      // 0x11C8(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSet<class FName>                             EnabledTagNames;                                   // 0x11D0(0x0050)(BlueprintVisible, BlueprintReadOnly, Transient, Protected, NativeAccessSpecifierProtected)

public:
	class UObject* GenerateItemObject(const struct FVAL_CharCustomization_AssetData& AssetData, const class UWidget* ViewWidget);
	void GenerateLoadoutSlotItems();
	void HandleLoadoutSlotItemsGenerated(const class FName& LoadoutSlotName, const struct FVALUI_CharCustomization_LoadoutSlotData& LoadoutSlotData);
	void HandleLoadoutUpdated(const struct FVALUI_CharCustomization_UpdateLoadoutContextPayload& ContextPayload);
...
static_assert(sizeof(UVALUI_CharacterCustomizationPanelBase) == 0x001220, "Wrong size on UVALUI_CharacterCustomizationPanelBase");
...
static_assert(offsetof(UVALUI_CharacterCustomizationPanelBase, LoadoutSlotMap) == 0x001178, "Member 'UVALUI_CharacterCustomizationPanelBase::LoadoutSlotMap' has a wrong offset!");
static_assert(offsetof(UVALUI_CharacterCustomizationPanelBase, ItemTypeEnum) == 0x0011C8, "Member 'UVALUI_CharacterCustomizationPanelBase::ItemTypeEnum' has a wrong offset!");
static_assert(offsetof(UVALUI_CharacterCustomizationPanelBase, EnabledTagNames) == 0x0011D0, "Member 'UVALUI_CharacterCustomizationPanelBase::EnabledTagNames' has a wrong offset!");
...
{
public:
	uint8                                         Pad_2C7D[0x50];                                    // 0x0520(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C7E[0x8];                                     // 0x0578(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void OnFirstTouch();
	void OnUpdateMovmentVirtualStick(bool TouchControlFlag, const struct FVector2D& Pos, const struct FVector2D& ControlVector);
...
{
public:
	void DisplayMessage(const struct FValeriaChatMessage& Message, class AActor* BubbleActor);
...
{
public:
	FMulticastInlineDelegateProperty_             OnBubbleRegistered;                                // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnBubbleUnregistered;                              // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TSubclassOf<class UWidgetComponent>           WidgetComponentClass;                              // 0x0050(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSet<class UUserWidget*>                      ActiveChatBubbleWidgets;                           // 0x0058(0x0050)(ExportObject, Transient, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_2C81[0x18];                                    // 0x00A8(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void HandleOnNewChatMessageReceived(const struct FValeriaChatMessage& Message);
	void OnBubbleRegistered__DelegateSignature(class UUserWidget* BubbleWidget, class AActor* BubbleActor);
	void OnBubbleUnregistered__DelegateSignature(class UUserWidget* BubbleWidget, class AActor* BubbleActor);
	void RegisterBubbleWidget(class UUserWidget* Widget, class AActor* BubbleActor);
	void UnregisterBubbleWidget(class UUserWidget* Widget, class AActor* BubbleActor);
...
static_assert(sizeof(UVALUI_ChatBubbleManager) == 0x0000C0, "Wrong size on UVALUI_ChatBubbleManager");
static_assert(offsetof(UVALUI_ChatBubbleManager, OnBubbleRegistered) == 0x000030, "Member 'UVALUI_ChatBubbleManager::OnBubbleRegistered' has a wrong offset!");
static_assert(offsetof(UVALUI_ChatBubbleManager, OnBubbleUnregistered) == 0x000040, "Member 'UVALUI_ChatBubbleManager::OnBubbleUnregistered' has a wrong offset!");
static_assert(offsetof(UVALUI_ChatBubbleManager, WidgetComponentClass) == 0x000050, "Member 'UVALUI_ChatBubbleManager::WidgetComponentClass' has a wrong offset!");
static_assert(offsetof(UVALUI_ChatBubbleManager, ActiveChatBubbleWidgets) == 0x000058, "Member 'UVALUI_ChatBubbleManager::ActiveChatBubbleWidgets' has a wrong offset!");

// Class ValeriaUI.VALUI_ChatEmojiPanel
// 0x0000 (0x02C0 - 0x02C0)
class UVALUI_ChatEmojiPanel final : public UUserWidget
{
public:
	const TSoftObjectPtr<class UTexture2D> GetTexture(const struct FS6UI_FRichImageRow_Soft& ImageRow) const;
...
class UVALUI_ChatInputBar final : public UUserWidget
{
public:
	uint8                                         Pad_2C82[0x68];                                    // 0x02C0(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C83[0x20];                                    // 0x0378(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C84[0x58];                                    // 0x0468(0x0058)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	bool ChangeMessageTarget(const struct FMessageTarget& MessageTarget);
	void CommitText();
	void CompleteSuggestion();
	void CycleToNextSuggestion();
	void CycleToPrevSuggestion();
	void DisplayActiveCommandHint(const class UVAL_ChatCommand_Base* Command, const bool bDisplay);
	void DisplayCommandSuggestions(const bool bInDisplay);
	void DisplayStringsSuggestions(const class FString& InString, const TArray<class FString>& Suggestions);
	void HandleOnChatChannelSet(const struct FVALUI_ChatChannel& Channel);
	void HandleOnDisplayCharacterNameSuggestions(const class FString& CharacterNameSubstr, const int32 MaxSuggestionsNum);
	void HandleOnHideSuggestions();
	void HandleOnStateChanged(EVALUI_ChatInputBarState NewStateId);
	void HandleOnTextChanged(const class FText& InText);
	void HandleOnTextCommitted(const class FText& InText, ETextCommit InCommitMethod);
	void PushErrorNotification(const class FText& InErrorText);
	struct FMessageTarget SwitchToNextChannel(bool bSwitchUp);
	void TryUpdateChatChannel();
	void VALUIEvent_OnCommandSuggestionsChanged__DelegateSignature(const class FString& InString, const TArray<class UVAL_ChatCommand_Base*>& CommandObjects);
	void VALUIEvent_OnCommitBlankText__DelegateSignature(class UVALUI_ChatInputBar* InputBar);
	void VALUIEvent_OnMessageSubmitted__DelegateSignature(class UVALUI_ChatInputBar* InputBar, const struct FMessageTarget& MessageTarget, const class FText& Message);
	void VALUIEvent_OnMessageTargetCycled__DelegateSignature(class UVALUI_ChatInputBar* InputBar, const struct FMessageTarget& MessageTarget);
	void VALUIEvent_OnTextChanged__DelegateSignature(class UVALUI_ChatInputBar* InputBar, const class FText& PreviousText, const class FText& NewText);
...
public:
	...
	uint8                                         Pad_2C8A[0x4];                                     // 0x086C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2C8B[0x30];                                    // 0x0930(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void InsertTextAtCursorChecked(const class FText& InText);
	...
	void VALUI_OnSummonContextMenu__DelegateSignature(const struct FGeometry& Geometry, const struct FPointerEvent& MouseEvent);
...
// 0x0000 (0x02C0 - 0x02C0)
class UVALUI_ChatMessage final : public UUserWidget
{
public:
	class FString ColorToHexString(const struct FLinearColor& Color) const;
...
class UVALUI_ChatPanelBase final : public US6UI_InputActionHandlingUserWidget
{
public:
	uint8                                         Pad_2C8C[0x68];                                    // 0x0520(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	...
	TSet<EMessageTargetType>                      MissingMessageTargetTypesForDisabledChannels;      // 0x0628(0x0050)(Transient, Protected, NativeAccessSpecifierProtected)

public:
	void ClearTabSidePanel(const struct FVALUI_ChatTab& Tab);
	void DisplayTab(const class FName& TabName);
	void GetTabWidgetReferences(const class FName& TabName, class UWidget** OutSidePanelWidget, class UWidget** OutMessagePanelWidget);
	void GotoChatState(EVALUI_ChatPanelState State);
	void HandleAddMessageToPanel(class UWidget* MessagePanel, const struct FValeriaChatMessage& ChatMessage, const struct FVALUI_ChatMessageConfig& MessageConfig);
	void HandleAddTabChannel(const struct FVALUI_ChatMessageConfig& MessageConfig);
	void HandleAddTabToTabHost(const class FName& TabName, const class FText& TabDisplayName);
	void HandleClearMessagePanel(class UWidget* MessagePanel);
	void HandleClearTabHost();
	void HandleDisplayChannelGlow(class UWidget* SidePanel, const struct FVALUI_ChatChannel& Channel, int32 ChannelIndex);
	void HandleDisplayTab(const class FName& TabName);
	void HandleMessageTargetRemoved(const struct FMessageTarget& MessageTarget);
	void HandleNewChatMessage(const struct FValeriaChatMessage& ChatMessage);
	void HandleNewControlMessage(const struct FControlMessage& ControlMessage);
	...
	void HandleRemoveSidePanelChannel(class UWidget* SidePanel, const int32 ChannelIndex);
	void HandleTabChannelEnabled(const struct FVALUI_ChatTab& Tab, const struct FVALUI_ChatChannel& Channel, const struct FVALUI_ChatMessageConfig& Config);
	void HandleToggleTabHost(const bool bEnabled);
	bool IsTabChannelEnabled(const class FName& TabName, const struct FMessageTarget& MessageTarget);
	void OnNewChatMessageAdded(const struct FValeriaChatMessage& ChatMessage);
	void RemoveTabChannel(struct FVALUI_ChatTab* Tab, const int32 ChannelIndex);
	void SwitchTab(const class FName& TabName);
	void ToggleAllChannels(const bool bEnabled);
	void ToggleChannelsByType(const bool bEnabled, const EMessageTargetType Type);
	void ToggleChatChannel(const struct FVALUI_ChatMessageConfig& MessageConfig);

	void GetChatMessageConfigs(const struct FValeriaChatMessage& Message, TArray<struct FVALUI_ChatMessageConfig>* OutMessageConfigs) const;
	EVALUI_ChatPanelState GetCurrentChatState() const;
	bool TryGetTabAndChannelFromMessageConfig(const struct FVALUI_ChatMessageConfig& Config, struct FVALUI_ChatTab* OutTab, struct FVALUI_ChatChannel* OutChannel) const;
...
static_assert(sizeof(UVALUI_ChatPanelBase) == 0x000678, "Wrong size on UVALUI_ChatPanelBase");
...
static_assert(offsetof(UVALUI_ChatPanelBase, MissingMessageTargetTypesForDisabledChannels) == 0x000628, "Member 'UVALUI_ChatPanelBase::MissingMessageTargetTypesForDisabledChannels' has a wrong offset!");
...
{
public:
	static TArray<struct FS6PLAT_ChatMessage> ConvertValeriaChatMessagesArrayToPlatformChatMessagesArray(const TArray<struct FValeriaChatMessage>& ChatMessages);
	static struct FS6PLAT_ChatMessage ConvertValeriaChatMessageToPlatformChatMessage(const struct FValeriaChatMessage& ChatMessages);
	static bool DoesChannelMatchMessageTarget(const struct FVALUI_ChatChannel& InChannel, const struct FMessageTarget& InMessageTarget);
	static TArray<struct FValeriaChatMessage> FetchChatMessages(class UObject* WorldContextObject, const struct FVALUI_ChatMessageFetchFilter& Filter);
	static TArray<struct FMessageTarget> GetMessageTargetsOfChannel(class UWorld* WorldContext, const struct FVALUI_ChatChannel& InChannel);
...
// Class ValeriaUI.VALUI_CommonDateTimeTextBlock
// 0x0000 (0x0400 - 0x0400)
class UVALUI_CommonDateTimeTextBlock final : public UCommonDateTimeTextBlock
{
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"VALUI_CommonDateTimeTextBlock">();
	}
	static class UVALUI_CommonDateTimeTextBlock* GetDefaultObj()
	{
		return GetDefaultObjImpl<UVALUI_CommonDateTimeTextBlock>();
	}
};
static_assert(alignof(UVALUI_CommonDateTimeTextBlock) == 0x000010, "Wrong alignment on UVALUI_CommonDateTimeTextBlock");
static_assert(sizeof(UVALUI_CommonDateTimeTextBlock) == 0x000400, "Wrong size on UVALUI_CommonDateTimeTextBlock");
...
public:
	bool GetCrafterData(const struct FCrafterConfig& CrafterConfig, struct FVALUI_Crafter* CrafterData) const;
	class FName GetCrafterRowName(const struct FCrafterConfig& CrafterConfig) const;
...
{
public:
	void DisplayCrafterStations(const struct FRecipeNeeds& RecipeNeeds);
...
public:
	...
	uint8                                         Pad_2C97[0x17];                                    // 0x0199(0x0017)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2C98[0x4];                                     // 0x01AC(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void SetForemostWidgetIndex(const int32 Param_Index);
...
public:
	...
	uint8                                         Pad_2C99[0x7];                                     // 0x00A1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void DragStarted(const struct FPointerEvent& PointerEvent);
...
{
public:
	uint8                                         Pad_2C9A[0x48];                                    // 0x0028(0x0048)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2C9B[0x4];                                     // 0x0064(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2C9C[0x8];                                     // 0x0528(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
class UVALUI_EmoteButton final : public UUserWidget
{
public:
...
{
public:
	void HandleErrorDisplay(const struct FVALUI_ErrorDisplayPayload& ErrorDisplayPayload);
...
{
public:
	static bool TryRaiseErrorForDisplay(class UWidget* InstigatingWidget, const struct FVALUI_ErrorDisplayPayload& ErrorDisplayPayload);
...
public:
	...
	uint8                                         Pad_2C9E[0xC];                                     // 0x02F4(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2C9F[0x8];                                     // 0x0498(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	void AddExtensibleWidget(const TSoftClassPtr<class UClass>& WidgetReference);
...
class UVALUI_GameInteractPopupSubsystem final : public ULocalPlayerSubsystem
{
public:
	uint8                                         Pad_2CA0[0x10];                                    // 0x0030(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UGameplayInteractivePopupDataAsset*> PendingPopupQueue;                                 // 0x0040(0x0010)(ZeroConstructor, Transient, Protected, NativeAccessSpecifierProtected)
	class UGameplayInteractivePopupDataAsset*     ActivePopup;                                       // 0x0050(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2CA1[0x8];                                     // 0x0058(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void AddPopupToQueue(const TSoftObjectPtr<class UGameplayInteractivePopupDataAsset> GpPopupAsset);
	bool TryForceDismissActivePopup();
...
static_assert(alignof(UVALUI_GameInteractPopupSubsystem) == 0x000008, "Wrong alignment on UVALUI_GameInteractPopupSubsystem");
static_assert(sizeof(UVALUI_GameInteractPopupSubsystem) == 0x000060, "Wrong size on UVALUI_GameInteractPopupSubsystem");
static_assert(offsetof(UVALUI_GameInteractPopupSubsystem, PendingPopupQueue) == 0x000040, "Member 'UVALUI_GameInteractPopupSubsystem::PendingPopupQueue' has a wrong offset!");
static_assert(offsetof(UVALUI_GameInteractPopupSubsystem, ActivePopup) == 0x000050, "Member 'UVALUI_GameInteractPopupSubsystem::ActivePopup' has a wrong offset!");

// Class ValeriaUI.VALUI_GameplayEventBroadcaster
// 0x0018 (0x02D8 - 0x02C0)
class UVALUI_GameplayEventBroadcaster final : public UUserWidget
{
public:
	struct FGameplayTag                           UiOpenedEventTag;                                  // 0x02C0(0x0008)(Edit, BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FGameplayTag                           UiClosedEventTag;                                  // 0x02C8(0x0008)(Edit, BlueprintVisible, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bNotifyGameplayEvents;                             // 0x02D0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2CA2[0x7];                                     // 0x02D1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void CustomGameplayEvent(const struct FGameplayTag& UiCustomEventTag);

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"VALUI_GameplayEventBroadcaster">();
	}
	static class UVALUI_GameplayEventBroadcaster* GetDefaultObj()
	{
		return GetDefaultObjImpl<UVALUI_GameplayEventBroadcaster>();
	}
};
static_assert(alignof(UVALUI_GameplayEventBroadcaster) == 0x000008, "Wrong alignment on UVALUI_GameplayEventBroadcaster");
static_assert(sizeof(UVALUI_GameplayEventBroadcaster) == 0x0002D8, "Wrong size on UVALUI_GameplayEventBroadcaster");
static_assert(offsetof(UVALUI_GameplayEventBroadcaster, UiOpenedEventTag) == 0x0002C0, "Member 'UVALUI_GameplayEventBroadcaster::UiOpenedEventTag' has a wrong offset!");
static_assert(offsetof(UVALUI_GameplayEventBroadcaster, UiClosedEventTag) == 0x0002C8, "Member 'UVALUI_GameplayEventBroadcaster::UiClosedEventTag' has a wrong offset!");
static_assert(offsetof(UVALUI_GameplayEventBroadcaster, bNotifyGameplayEvents) == 0x0002D0, "Member 'UVALUI_GameplayEventBroadcaster::bNotifyGameplayEvents' has a wrong offset!");

// Class ValeriaUI.VALUI_GpInteractivePopupBase
// 0x0070 (0x0580 - 0x0510)
class UVALUI_GpInteractivePopupBase final : public UCommonActivatableWidgetInputExtended
{
public:
	...
	FMulticastInlineDelegateProperty_             OnPopupBlocked;                                    // 0x0520(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPopupUnblocked;                                  // 0x0530(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	class UGameplayInteractivePopupDataAsset*     InteractivePopupDataAsset;                         // 0x0540(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UVALUI_GameInteractPopupSubsystem*      PopupSubSystem;                                    // 0x0548(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2CA3[0x8];                                     // 0x0550(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	class UVAL_GameplayConditionDef*              GameplayCondition;                                 // 0x0558(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class AValeriaCharacter*                      ValeriaCharacter;                                  // 0x0560(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class AValeriaPlayerController*               ValeriaPlayerController;                           // 0x0568(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UVALUI_UIManagerWidgetBase*             ValuiManager;                                      // 0x0570(0x0008)(ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2CA4[0x8];                                     // 0x0578(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void CheckGameplayCondition();
	void ClosePopupWidget();
	void ForceDismissPopup();
	...
	void HandleForceDismissPopup();
	void HandlePopupBlocked();
	void HandlePopupUnblocked();
	void HandlePremiumStoreToggled(class AValeriaPlayerController* PlayerController, bool bIsStoreActive);
	void OnUIAction(const struct FGameplayTag& UITag, const class UUserWidget* Widget);
	void SetInteractivePopupDataAsset(const class UGameplayInteractivePopupDataAsset* InteractivePopupAsset);
...
static_assert(sizeof(UVALUI_GpInteractivePopupBase) == 0x000580, "Wrong size on UVALUI_GpInteractivePopupBase");
...
static_assert(offsetof(UVALUI_GpInteractivePopupBase, OnPopupBlocked) == 0x000520, "Member 'UVALUI_GpInteractivePopupBase::OnPopupBlocked' has a wrong offset!");
static_assert(offsetof(UVALUI_GpInteractivePopupBase, OnPopupUnblocked) == 0x000530, "Member 'UVALUI_GpInteractivePopupBase::OnPopupUnblocked' has a wrong offset!");
static_assert(offsetof(UVALUI_GpInteractivePopupBase, InteractivePopupDataAsset) == 0x000540, "Member 'UVALUI_GpInteractivePopupBase::InteractivePopupDataAsset' has a wrong offset!");
static_assert(offsetof(UVALUI_GpInteractivePopupBase, PopupSubSystem) == 0x000548, "Member 'UVALUI_GpInteractivePopupBase::PopupSubSystem' has a wrong offset!");
static_assert(offsetof(UVALUI_GpInteractivePopupBase, GameplayCondition) == 0x000558, "Member 'UVALUI_GpInteractivePopupBase::GameplayCondition' has a wrong offset!");
static_assert(offsetof(UVALUI_GpInteractivePopupBase, ValeriaCharacter) == 0x000560, "Member 'UVALUI_GpInteractivePopupBase::ValeriaCharacter' has a wrong offset!");
static_assert(offsetof(UVALUI_GpInteractivePopupBase, ValeriaPlayerController) == 0x000568, "Member 'UVALUI_GpInteractivePopupBase::ValeriaPlayerController' has a wrong offset!");
static_assert(offsetof(UVALUI_GpInteractivePopupBase, ValuiManager) == 0x000570, "Member 'UVALUI_GpInteractivePopupBase::ValuiManager' has a wrong offset!");
...
{
public:
	bool                                          bWantShow;                                         // 0x02E8(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2CA6[0x7];                                     // 0x02E9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void BP_DisableTimer();
	void BP_StartTimer(float SecondsLeft, EHotPotTurnState TurnState);
	void BP_UpdatePlayerID(const struct FGuid& PlayerId, const struct FGuid& CharacterId);
	void BP_UpdateVisibility();
	void TryShow(bool bShow);
...
static_assert(sizeof(UVALUI_HotPotTurnTimer) == 0x0002F0, "Wrong size on UVALUI_HotPotTurnTimer");
static_assert(offsetof(UVALUI_HotPotTurnTimer, bWantShow) == 0x0002E8, "Member 'UVALUI_HotPotTurnTimer::bWantShow' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2CA8[0x6];                                     // 0x02DA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2CA9[0x18];                                    // 0x0338(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2CAB[0xB0];                                    // 0x0050(0x00B0)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void HandleItemAcquired(const struct FValeriaItem& Item);
	void HandleNotificationDismissed(class UVALUI_NotificationQueue* NotificationQueue, const struct FGuid& AffectedNotificationId, class UWidget* NotificationWidget);
	class UWidget* OnCreateItemAcquisitionNotification__DelegateSignature(class UVALUI_ItemAcquisitionNotifier* Notifier);
	void Setup(class UInventoryComponent* SourceInventoryComponent, class UVALUI_NotificationQueue* TargetNotificationQueue, const TSoftClassPtr<class UClass>& InWidgetClass);
...
class UVALUI_ItemDragDrop final : public UVALUI_DragDropOperation
{
public:
	...
	uint8                                         Pad_2CAC[0x7];                                     // 0x00A9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2CAD[0xE];                                     // 0x0512(0x000E)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2CAE[0x1];                                     // 0x0033(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2CAF[0x2];                                     // 0x004E(0x0002)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2CB0[0x7];                                     // 0x07A1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2CB1[0x3];                                     // 0x07C9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
class UVALUI_MainHUDWidget final : public US6UI_StateUserWidget
{
public:
	FMulticastInlineDelegateProperty_             OnHUDStateChanged;                                 // 0x0558(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)

public:
	void HandleOnHUDStateChanged(const struct FVALUI_MainHUDState& State);
	void HandleOnSocialTrackingDataChanged(const struct FVALUI_SocialTrackingData& SocialData);
	...
	void OnHUDStateChanged__DelegateSignature(const struct FVALUI_MainHUDState& State);
...
static_assert(sizeof(UVALUI_MainHUDWidget) == 0x000568, "Wrong size on UVALUI_MainHUDWidget");
static_assert(offsetof(UVALUI_MainHUDWidget, OnHUDStateChanged) == 0x000558, "Member 'UVALUI_MainHUDWidget::OnHUDStateChanged' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2CB2[0x8];                                     // 0x10A8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2CB4[0x7];                                     // 0x0559(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2CB5[0x10];                                    // 0x0578(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	class UVALUI_NewsInboxMessageDataAsset* GetNewsInboxMessageDefinitionByType(const EVAL_NewsInboxMessageType EMessageType) const;
	class UVALUI_NewsInboxMessageDataAsset* GetNewsInboxMessageDefinitionFromRewardIndex(const int32 Param_Index, const bool Claimed) const;
...
// 0x0000 (0x0028 - 0x0028)
class UVALUI_NotificationFactory final : public UObject
{
public:
	static class UClass* StaticClass()
	{
...
{
public:
	void HandleNotificationDismissed(class UVALUI_NotificationQueue* NotificationQueue, const struct FGuid& NotificationId);
	void HandleNotificationShown(class UVALUI_NotificationQueue* NotificationQueue, const struct FGuid& NotificationId);
	bool MatchesNotification(const class FText& NotificationText, const TSoftObjectPtr<class UTexture2D>& NotificationIcon);
...
public:
	...
	uint8                                         Pad_2CB9[0x8];                                     // 0x0068(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void OnNotificationDismissed__DelegateSignature(class UVALUI_NotificationQueue* NotificationQueue, const struct FGuid& AffectedNotificationId, class UWidget* NotificationWidget);
	void OnNotificationPushed__DelegateSignature(class UVALUI_NotificationQueue* NotificationQueue, const struct FGuid& AffectedNotificationId);
	void OnNotificationShown(const struct FGuid& NotificationId);
	struct FGuid PushNotification(class UWidget* NotificationWidget);
	bool TryDismissNotification(const struct FGuid& NotificationId);
	bool TryDismissPendingNotification(const struct FGuid& NotificationId);
	...
	class UWidget* GetNotificationById(const struct FGuid& NotificationId) const;
...
public:
	...
	uint8                                         Pad_2CBC[0x7];                                     // 0x0079(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	void DisplayActiveTrack(const TArray<class UVAL_PaliaPassRewardObject_Base*>& Rewards);
	void HandleOnHUDStateChanged(const struct FVALUI_PaliaPassHUDState& State);
	void HandleOnViewModelHUDStateChanged(class UObject* Object, const struct FFieldNotificationId& Field);
...
// 0x0008 (0x0560 - 0x0558)
class UVALUI_PlayerSupport final : public UVALUI_ModalWidgetBase
{
public:
...
public:
	...
	void OnQrReceived(const class FString& Link, const TArray<uint8>& QrData, int32 Size);
...
{
public:
	uint8                                         Pad_2CBF[0x8];                                     // 0x05D8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	FMulticastInlineDelegateProperty_             OnUIEventOccured;                                  // 0x0600(0x0010)(ZeroConstructor, InstancedReference, NativeAccessSpecifierPublic)
	class ULocalPlayer*                           LocalPlayer;                                       // 0x0610(0x0008)(ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2CC0[0xA0];                                    // 0x0618(0x00A0)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	bool GetStoredCrafterUIState(const class FName& CrafterName, struct FCrafterUIState* OutCrafterUIState);
	void Implementation_AddPopupToQueue(class AValeriaPlayerController* PlayerController, const TSoftObjectPtr<class UGameplayInteractivePopupDataAsset>& GpPopupAsset);
	void Implementation_CloseMenuHub();
	void Implementation_CloseMinigameScreen();
	bool Implementation_HasAnyHousingPlotsTeleportOptions(class AVAL_TeleporterBase* Teleporter);
	void Implementation_NavigateToOnlinePhotoAlbum(const struct FGuid& IdOfPhotoToNavigateTo, const bool bShouldSelectPhoto);
	void Implementation_NavigateToRecentPhotos(const struct FGuid& IdOfPhotoToNavigateTo, const bool bShouldSelectPhoto);
	void Implementation_OpenAmmoMenu(const EAmmoType AmmoType);
	void Implementation_OpenBook(const int32 BookId);
	void Implementation_OpenBundleDropOffMenu(const class UVAL_BundleShrineConfigAsset* BundleShrineConfigAsset);
	...
	void Implementation_OpenGameplayInteractiveModal(const class UGameplayInteractivePopupDataAsset* PopupAsset);
	...
	void Implementation_OpenLoginIncorrectAccount();
	void Implementation_OpenMailbox();
	void Implementation_OpenMenuHub();
	void Implementation_OpenMinigameScreen(const class UMinigameDataAsset* InMinigameConfig, const class UMinigameManagerComponent* MinigameManager);
	void Implementation_OpenNewsInbox();
	void Implementation_OpenPaliaPass();
	void Implementation_OpenPetBonus(const TSet<TSoftObjectPtr<class UVAL_CharacterCustomizationItem_Pet>>& Items);
	void Implementation_OpenPlayerStorage();
	void Implementation_OpenPremiumStore(const struct FVAL_OpenStorePayload& Payload);
	...
	void Implementation_OpenRequestItem(const class FName Tag);
	...
	void Implementation_OpenStore(const class UVillagerStoreConfig* StoreConfig);
	void Implementation_OpenTourBoard();
	void Implementation_OpenTradeMenu(class AActor* TradeKioskActor);
	void Implementation_OpenVillagerStore(int32 VillagerConfigId);
	void Implementation_OpenWishView(const TArray<struct FWishTreeEntry>& Wishes, const class UVillagerWishDataAsset* VillagerWishOverride);
	void Implementation_ToggleCollectionsMenu(const EVAL_CollectionsTabState& TabState);
	void Implementation_ToggleGameplayMenuMode(const EVAL_GameplayMenuMode Mode);
	void NavigateToOnlinePhotoAlbum(const struct FGuid& IdOfPhotoToNavigateTo, const bool bShouldSelectPhoto);
	void NavigateToRecentPhotos(const struct FGuid& IdOfPhotoToNavigateTo, const bool bShouldSelectPhoto);
	void OnItemDragDropped(class UDragDropOperation* Operation);
	void OpenBook(const int32 BookId);
	void OpenTutorialModal(const class FName& TutorialModalName);
	void OpenVillagerStore(int32 VillagerConfigId);
	void RegisterCallbacksAndBroadcastNewDragDrop(const class UVALUI_ItemDragDrop* ItemDragDrop);
	void SetStoredCrafterUIState(const class FName& CrafterName, const struct FCrafterUIState& CrafterUIState);
...
static_assert(sizeof(UVALUI_UIManagerWidgetBase) == 0x0006B8, "Wrong size on UVALUI_UIManagerWidgetBase");
...
static_assert(offsetof(UVALUI_UIManagerWidgetBase, OnUIEventOccured) == 0x000600, "Member 'UVALUI_UIManagerWidgetBase::OnUIEventOccured' has a wrong offset!");
static_assert(offsetof(UVALUI_UIManagerWidgetBase, LocalPlayer) == 0x000610, "Member 'UVALUI_UIManagerWidgetBase::LocalPlayer' has a wrong offset!");

// Class ValeriaUI.VALUI_PregameUIManager
// 0x00F8 (0x07B0 - 0x06B8)
class UVALUI_PregameUIManager final : public UVALUI_UIManagerWidgetBase
{
public:
	uint8                                         Pad_2CC8[0x68];                                    // 0x06B8(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnPregameStateChange;                              // 0x0720(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnLobbyStateChange;                                // 0x0730(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	class AVAL_CharacterRenderStudio*             RenderStudio;                                      // 0x0740(0x0008)(BlueprintVisible, ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 AnnouncementURL;                                   // 0x0748(0x0010)(Edit, BlueprintVisible, ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 Announcement;                                      // 0x0758(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	struct FDateTime                              AnnouncementTimestamp;                             // 0x0768(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 ServerStatusURL;                                   // 0x0770(0x0010)(Edit, BlueprintVisible, ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class FString                                 ServerStatus;                                      // 0x0780(0x0010)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bEnableAutoLogin;                                  // 0x0790(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2CC9[0x1F];                                    // 0x0791(0x001F)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void DeinitAutoLogin();
	void FetchServerStatus();
	void GetCachedCharacterAtIndex_Checked(const int32 Param_Index, struct FVALDTOS_MetaCharacterFormat* OutCharacter);
	...
	void HandleOnCharacterListObtained(const TArray<struct FVALDTOS_MetaCharacterFormat>& InCachedCharacters);
...
static_assert(sizeof(UVALUI_PregameUIManager) == 0x0007B0, "Wrong size on UVALUI_PregameUIManager");
static_assert(offsetof(UVALUI_PregameUIManager, OnPregameStateChange) == 0x000720, "Member 'UVALUI_PregameUIManager::OnPregameStateChange' has a wrong offset!");
static_assert(offsetof(UVALUI_PregameUIManager, OnLobbyStateChange) == 0x000730, "Member 'UVALUI_PregameUIManager::OnLobbyStateChange' has a wrong offset!");
static_assert(offsetof(UVALUI_PregameUIManager, RenderStudio) == 0x000740, "Member 'UVALUI_PregameUIManager::RenderStudio' has a wrong offset!");
static_assert(offsetof(UVALUI_PregameUIManager, AnnouncementURL) == 0x000748, "Member 'UVALUI_PregameUIManager::AnnouncementURL' has a wrong offset!");
static_assert(offsetof(UVALUI_PregameUIManager, Announcement) == 0x000758, "Member 'UVALUI_PregameUIManager::Announcement' has a wrong offset!");
static_assert(offsetof(UVALUI_PregameUIManager, AnnouncementTimestamp) == 0x000768, "Member 'UVALUI_PregameUIManager::AnnouncementTimestamp' has a wrong offset!");
static_assert(offsetof(UVALUI_PregameUIManager, ServerStatusURL) == 0x000770, "Member 'UVALUI_PregameUIManager::ServerStatusURL' has a wrong offset!");
static_assert(offsetof(UVALUI_PregameUIManager, ServerStatus) == 0x000780, "Member 'UVALUI_PregameUIManager::ServerStatus' has a wrong offset!");
static_assert(offsetof(UVALUI_PregameUIManager, bEnableAutoLogin) == 0x000790, "Member 'UVALUI_PregameUIManager::bEnableAutoLogin' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2CCC[0x13];                                    // 0x0411(0x0013)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2CCD[0x24];                                    // 0x042C(0x0024)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	void HandleBundleOffersAvailable(const TArray<struct FVALUI_PremiumCurrencyBundle>& Bundles);
	void HandleBundleOffersFailed();
	void HandleCheckoutCancelled();
	...
	void HandleSteamMicrotransactionCompleted(const uint32 AppID, const uint64 OrderId, const bool bAuthorized);
	void HandleUrlChanged(const class FText& Text);
	void HandleValidatePaymentFulfillmentTick(const struct FGuid& PaymentID);
	void PurchasePremiumCurrency(const struct FGuid& BundleId);
...
public:
	...
	TArray<class UVAL_CharacterCustomizationItemBase*> GetCustomizationItemsForGuids(const TArray<struct FGuid>& ItemIds);
	TMap<class FName, class UVAL_CharacterCustomizationItemBase*> GetLoadoutOverridesForCatalogItems(const TArray<class UVAL_CharacterCustomizationItemBase*>& Items);
...
// Class ValeriaUI.VALUI_TileItem_PremiumStorefrontTile
// 0x00E0 (0x0108 - 0x0028)
class UVALUI_TileItem_PremiumStorefrontTile final : public UObject
{
public:
	struct FVALUI_PremiumStorefrontWidgetModel    Model;                                             // 0x0028(0x00D0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnSelected;                                        // 0x00F8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"VALUI_TileItem_PremiumStorefrontTile">();
	}
	static class UVALUI_TileItem_PremiumStorefrontTile* GetDefaultObj()
	{
		return GetDefaultObjImpl<UVALUI_TileItem_PremiumStorefrontTile>();
	}
};
static_assert(alignof(UVALUI_TileItem_PremiumStorefrontTile) == 0x000008, "Wrong alignment on UVALUI_TileItem_PremiumStorefrontTile");
static_assert(sizeof(UVALUI_TileItem_PremiumStorefrontTile) == 0x000108, "Wrong size on UVALUI_TileItem_PremiumStorefrontTile");
static_assert(offsetof(UVALUI_TileItem_PremiumStorefrontTile, Model) == 0x000028, "Member 'UVALUI_TileItem_PremiumStorefrontTile::Model' has a wrong offset!");
static_assert(offsetof(UVALUI_TileItem_PremiumStorefrontTile, OnSelected) == 0x0000F8, "Member 'UVALUI_TileItem_PremiumStorefrontTile::OnSelected' has a wrong offset!");
...
{
public:
	uint8                                         Pad_2CD0[0x8];                                     // 0x02C0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnSelected;                                        // 0x02C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, BlueprintCallable, NativeAccessSpecifierPublic)
	struct FVALUI_PremiumStorefrontWidgetModel    Model;                                             // 0x02D8(0x00D0)(BlueprintVisible, BlueprintReadOnly, Protected, NativeAccessSpecifierProtected)

public:
	void HandleModelUpdate(const struct FVALUI_PremiumStorefrontWidgetModel& NewModel);
	void OnSelected__DelegateSignature(class UVALUI_PremiumStorefrontTileWidgetBase* Widget);
	void SetModel(const struct FVALUI_PremiumStorefrontWidgetModel& NewModel);
...
static_assert(sizeof(UVALUI_PremiumStorefrontTileWidgetBase) == 0x0003A8, "Wrong size on UVALUI_PremiumStorefrontTileWidgetBase");
static_assert(offsetof(UVALUI_PremiumStorefrontTileWidgetBase, OnSelected) == 0x0002C8, "Member 'UVALUI_PremiumStorefrontTileWidgetBase::OnSelected' has a wrong offset!");
static_assert(offsetof(UVALUI_PremiumStorefrontTileWidgetBase, Model) == 0x0002D8, "Member 'UVALUI_PremiumStorefrontTileWidgetBase::Model' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2CD1[0x4];                                     // 0x0414(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class UVALUI_TileView_Styled*                 StoreGrid;                                         // 0x0418(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
public:
	void CreateStorefrontGrid(int32 WidgetsPerRow, const TArray<struct FVALUI_PremiumStorefrontWidgetModel>& Models, const struct FVALUI_PremiumStoreTabPayload& TabTypePayload);
	bool FetchStorefront();
	void HandleStorefrontAvailable(const struct FVALUI_PremiumStorefrontResponse& Response);
	void HandleStorefrontError();
	void HandleTileSelected(const struct FVALUI_PremiumStorefrontWidgetModel& Model);
...
{
public:
	uint8                                         Pad_2CD3[0x68];                                    // 0x0558(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	void GoToPremiumStoreState(const EVALUI_PremiumStoreState NewState);
...
public:
	...
	uint8                                         Pad_2CD5[0x4];                                     // 0x003C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<TSubclassOf<class UVAL_PremiumItemAsset>> ItemSlotOrder;                                     // 0x0040(0x0010)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Config, UObjectWrapper, NativeAccessSpecifierPublic)
	TMap<TSubclassOf<class UVAL_PremiumItemAsset>, TSoftObjectPtr<class UTexture2D>> ItemClassToIcon;                                   // 0x0050(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, Config, UObjectWrapper, NativeAccessSpecifierPublic)
...
{
public:
	static TMap<struct FVALUI_PremiumStorefrontVariant, struct FVALUI_PremiumStorefrontWidgetModel> GetMultiplsVariantsDataFromItemIds(const struct FVALUI_PremiumStorefrontResponse& StorefrontResponse, const TSet<struct FGuid>& ItemIds);
	static TArray<TSoftObjectPtr<class UVAL_CharacterCustomizationItem_Pet>> GetNewPetsForBonusReceivedModal(const struct FVAL_CharacterCustomization_PetPurchaseBonus& PetPurchaseBonus, const TSet<struct FGuid>& NewEntitlements);
	static struct FVAL_CharacterCustomization_PetPurchaseBonus GetPetPurchaseBonusFromPurchaseRewards(const struct FVALUI_PremiumStorefrontPurchaseRewards& PurchaseRewards);
	static bool ShouldShowBuyButtonOnTile(const struct FVALUI_PremiumStorefrontVariant& Variant);
	static bool ShouldShowEquipButtonForClasses(const TSet<TSubclassOf<class UVAL_PremiumItemAsset>>& ItemClasses);
	static void SortItemsByItemSlot(TArray<class UVAL_PremiumItemAsset*>& OutItems);
...
{
public:
	uint8                                         Pad_2CD8[0x50];                                    // 0x01D8(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2CD9[0x4];                                     // 0x0284(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2CDA[0x18];                                    // 0x0378(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void SetIndex(const int32 Param_Index, bool bSkipSliderAnimation, bool bForce);
	...
	class UUserWidget* GetWidgetAtIndex(const int32 Param_Index) const;
...
class UVALUI_RichTextBlockDecorator_RequestLink final : public URichTextBlockDecorator
{
public:
...
public:
	...
	bool                                          bOverrideDefaultStyle;                             // 0x0048(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2CE1[0x7];                                     // 0x0049(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2CE2[0x7];                                     // 0x08A9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2CE3[0x10];                                    // 0x0900(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2CE4[0x7];                                     // 0x0CF9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2CE5[0x4];                                     // 0x006C(0x0004)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2CE6[0x8];                                     // 0x0738(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
class UVALUI_SocialPanelBase final : public US6UI_InputActionHandlingUserWidget
{
public:
...
// 0x0000 (0x0558 - 0x0558)
class UVALUI_StateUserWidget_PregameHUD final : public US6UI_StateUserWidget
{
public:
...
class UVALUI_TabButtonHostBase final : public UUserWidget
{
public:
...
public:
	void AddTabButton(const class FName& TabName, const struct FVALUI_InstantiatedTabButtonInfo& Info);
	void HandleDifferentActiveTabSet(const class FName TabName);
	void HideTabButton(const class FName& TabName, const struct FVALUI_InstantiatedTabButtonInfo& Info);
	void OnDifferentActiveTabSet__DelegateSignature(class UVALUI_TabButtonHostBase* TabButtonHost);
	void RegisterNewTab(const class FName& TabName, const class FText& TabDisplayName, class UButton* Button, class UWidget* AssociatedContent, TSoftObjectPtr<class UTexture2D> IconTexture, const struct FVector2D& IconSize);
	void RemoveTabButton(const class FName& TabName, const struct FVALUI_InstantiatedTabButtonInfo& Info);
	void SetTabButtonVisibility(const class FName& TabName, const ESlateVisibility NewVisibility);
	void ShowTabButton(const class FName& TabName, const struct FVALUI_InstantiatedTabButtonInfo& Info);
	bool TrySetActiveTabName(const class FName TabName, const bool bForceSet);
	void UnregisterTab(const class FName& TabName);

	class FName GetActiveTabName() const;
	TArray<class FName> GetTabNames() const;
	bool TryGetTabInfo(const class FName& TabName, struct FVALUI_InstantiatedTabButtonInfo* OutInfo) const;
...
{
public:
	void SetIsActiveTabButton(const bool bIsActive);
...
public:
	...
	uint8                                         Pad_2CEA[0x4];                                     // 0x0044(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2CEB[0x7];                                     // 0x0369(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	struct FFontOutlineSettings                   OverrideOutlineSettings;                           // 0x0378(0x0020)(Edit, BlueprintVisible, BlueprintReadOnly, Transient, EditConst, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<ERedirectsPlatform, TSoftObjectPtr<class UVALUI_TextBlockStyle>> CrossPlatformStyles;                               // 0x0398(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, UObjectWrapper, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnStyleLoadComplete;                               // 0x03E8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_2CEC[0x18];                                    // 0x03F8(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void ClearTextOutlineOverride();
	void OnStyleLoadComplete__DelegateSignature();
	void SetTextBlockStyle(class UVALUI_TextBlockStyle* NewStyle);
	void SetTextOutlineOverride(const struct FFontOutlineSettings& NewOutline);
	void StyleLoadComplete();
	void UpdateCrossPlatformStyles(const TMap<ERedirectsPlatform, TSoftObjectPtr<class UVALUI_TextBlockStyle>>& NewCrossPlatformStyles);
...
static_assert(sizeof(UVALUI_TextBlock_Styled) == 0x000410, "Wrong size on UVALUI_TextBlock_Styled");
...
static_assert(offsetof(UVALUI_TextBlock_Styled, OverrideOutlineSettings) == 0x000378, "Member 'UVALUI_TextBlock_Styled::OverrideOutlineSettings' has a wrong offset!");
static_assert(offsetof(UVALUI_TextBlock_Styled, CrossPlatformStyles) == 0x000398, "Member 'UVALUI_TextBlock_Styled::CrossPlatformStyles' has a wrong offset!");
static_assert(offsetof(UVALUI_TextBlock_Styled, OnStyleLoadComplete) == 0x0003E8, "Member 'UVALUI_TextBlock_Styled::OnStyleLoadComplete' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2CED[0x16];                                    // 0x004A(0x0016)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2CEE[0x4];                                     // 0x01C4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2CEF[0x18];                                    // 0x0228(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	struct FButtonStyle                           WidgetStyleOverride;                               // 0x0240(0x03F0)(Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_2CF0[0x10];                                    // 0x0630(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	struct FEventReply OnMouseButtonClicked(const struct FGeometry& MyGeometry, const struct FPointerEvent& InMouseEvent);
	void SetButtonConfig(const class UVALUI_ButtonStyle* NewButtonStyle);
	void SetButtonStyle(const struct FButtonStyle& WidgetStyle);
...
class AVALUI_UIManagerHUDBase final : public AS6UI_UIManagerHUDBase
{
public:
	static class UClass* StaticClass()
	{
...
public:
	...
	static class FString ColorToHexString(const struct FLinearColor& Color);
...
{
public:
	FMulticastInlineDelegateProperty_             PlatformInvitedFailed_FTUEInProgress;              // 0x0208(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_2CF1[0x70];                                    // 0x0218(0x0070)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void OnLoginFailure(const class FString& ErrorMessage, int32 ErrorCode);
	void PlatformInvitedFailed_FTUEInProgress__DelegateSignature(const class FText& ErrorMessage);
...
static_assert(sizeof(UVAL_PlatformInvitationManager) == 0x000288, "Wrong size on UVAL_PlatformInvitationManager");
static_assert(offsetof(UVAL_PlatformInvitationManager, PlatformInvitedFailed_FTUEInProgress) == 0x000208, "Member 'UVAL_PlatformInvitationManager::PlatformInvitedFailed_FTUEInProgress' has a wrong offset!");

// Class ValeriaUI.VAL_RadialWheelSlotContentWidget
// 0x0018 (0x02D8 - 0x02C0)
class UVAL_RadialWheelSlotContentWidget final : public UUserWidget
{
public:
	class AValeriaCharacter*                      OwningCharacter;                                   // 0x02C0(0x0008)(BlueprintVisible, ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class AValeriaPlayerController*               OwningPlayerController;                            // 0x02C8(0x0008)(BlueprintVisible, ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UVAL_RadialWheelSlotWidget*             OwningRadialWheelSlot;                             // 0x02D0(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)

public:
	void BPIE_RadialWheelSlotHoveredChanged(class UVAL_RadialWheelSlotWidget* RadialSlot, bool bNewHovered);
	bool BPNE_InvokeContentAction();
	void BPNE_ResetAnimatedProperties();

	class AValeriaCharacter* GetOwningCharacter() const;
	class AValeriaPlayerController* GetOwningPlayerController() const;

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"VAL_RadialWheelSlotContentWidget">();
	}
	static class UVAL_RadialWheelSlotContentWidget* GetDefaultObj()
	{
		return GetDefaultObjImpl<UVAL_RadialWheelSlotContentWidget>();
	}
};
static_assert(alignof(UVAL_RadialWheelSlotContentWidget) == 0x000008, "Wrong alignment on UVAL_RadialWheelSlotContentWidget");
static_assert(sizeof(UVAL_RadialWheelSlotContentWidget) == 0x0002D8, "Wrong size on UVAL_RadialWheelSlotContentWidget");
static_assert(offsetof(UVAL_RadialWheelSlotContentWidget, OwningCharacter) == 0x0002C0, "Member 'UVAL_RadialWheelSlotContentWidget::OwningCharacter' has a wrong offset!");
static_assert(offsetof(UVAL_RadialWheelSlotContentWidget, OwningPlayerController) == 0x0002C8, "Member 'UVAL_RadialWheelSlotContentWidget::OwningPlayerController' has a wrong offset!");
static_assert(offsetof(UVAL_RadialWheelSlotContentWidget, OwningRadialWheelSlot) == 0x0002D0, "Member 'UVAL_RadialWheelSlotContentWidget::OwningRadialWheelSlot' has a wrong offset!");

// Class ValeriaUI.VAL_RadialWheelSlotWidget
// 0x0048 (0x0308 - 0x02C0)
class UVAL_RadialWheelSlotWidget final : public UUserWidget
{
public:
	class UNamedSlot*                             ContentNamedSlot;                                  // 0x02C0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	FMulticastInlineDelegateProperty_             OnRadialWheelSlotHoveredChanged;                   // 0x02C8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	int32                                         SlotIndex;                                         // 0x02D8(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bCustomLocation;                                   // 0x02DC(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2CF4[0x3];                                     // 0x02DD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	float                                         SlotAngle;                                         // 0x02E0(0x0004)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2CF5[0x4];                                     // 0x02E4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class AValeriaCharacter*                      OwningCharacter;                                   // 0x02E8(0x0008)(BlueprintVisible, ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class AValeriaPlayerController*               OwningPlayerController;                            // 0x02F0(0x0008)(BlueprintVisible, ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UVAL_RadialWheelSlotContentWidget*      ManagedRadialWheelSlotContentWidget;               // 0x02F8(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	bool                                          bRadialWheelSlotHovered;                           // 0x0300(0x0001)(BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2CF6[0x7];                                     // 0x0301(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void BPNE_BeginHover();
	void BPNE_EndHover();
	void BPNE_ResetAnimatedProperties();
	void ClearSlotContent();
	void SetManagedRadialWheelSlotContentWidget(class UVAL_RadialWheelSlotContentWidget* InRadialWheelSlotContentWidget);
	bool TryInvokeContentAction();

	class UVAL_RadialWheelSlotContentWidget* GetManagedRadialWheelSlotContentWidget() const;
	class AValeriaCharacter* GetOwningCharacter() const;
	class AValeriaPlayerController* GetOwningPlayerController() const;
	float GetSlotAngle() const;
	int32 GetSlotIndex() const;
	bool HasCustomLocation() const;
	bool IsRadialWheelSlotHovered() const;

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"VAL_RadialWheelSlotWidget">();
	}
	static class UVAL_RadialWheelSlotWidget* GetDefaultObj()
	{
		return GetDefaultObjImpl<UVAL_RadialWheelSlotWidget>();
	}
};
static_assert(alignof(UVAL_RadialWheelSlotWidget) == 0x000008, "Wrong alignment on UVAL_RadialWheelSlotWidget");
static_assert(sizeof(UVAL_RadialWheelSlotWidget) == 0x000308, "Wrong size on UVAL_RadialWheelSlotWidget");
static_assert(offsetof(UVAL_RadialWheelSlotWidget, ContentNamedSlot) == 0x0002C0, "Member 'UVAL_RadialWheelSlotWidget::ContentNamedSlot' has a wrong offset!");
static_assert(offsetof(UVAL_RadialWheelSlotWidget, OnRadialWheelSlotHoveredChanged) == 0x0002C8, "Member 'UVAL_RadialWheelSlotWidget::OnRadialWheelSlotHoveredChanged' has a wrong offset!");
static_assert(offsetof(UVAL_RadialWheelSlotWidget, SlotIndex) == 0x0002D8, "Member 'UVAL_RadialWheelSlotWidget::SlotIndex' has a wrong offset!");
static_assert(offsetof(UVAL_RadialWheelSlotWidget, bCustomLocation) == 0x0002DC, "Member 'UVAL_RadialWheelSlotWidget::bCustomLocation' has a wrong offset!");
static_assert(offsetof(UVAL_RadialWheelSlotWidget, SlotAngle) == 0x0002E0, "Member 'UVAL_RadialWheelSlotWidget::SlotAngle' has a wrong offset!");
static_assert(offsetof(UVAL_RadialWheelSlotWidget, OwningCharacter) == 0x0002E8, "Member 'UVAL_RadialWheelSlotWidget::OwningCharacter' has a wrong offset!");
static_assert(offsetof(UVAL_RadialWheelSlotWidget, OwningPlayerController) == 0x0002F0, "Member 'UVAL_RadialWheelSlotWidget::OwningPlayerController' has a wrong offset!");
static_assert(offsetof(UVAL_RadialWheelSlotWidget, ManagedRadialWheelSlotContentWidget) == 0x0002F8, "Member 'UVAL_RadialWheelSlotWidget::ManagedRadialWheelSlotContentWidget' has a wrong offset!");
static_assert(offsetof(UVAL_RadialWheelSlotWidget, bRadialWheelSlotHovered) == 0x000300, "Member 'UVAL_RadialWheelSlotWidget::bRadialWheelSlotHovered' has a wrong offset!");

// Class ValeriaUI.VAL_RadialWheelWidget
// 0x00B0 (0x05D0 - 0x0520)
class UVAL_RadialWheelWidget final : public US6UI_InputActionHandlingUserWidget
{
public:
	class UValeriaGameInstance*                   ValeriaGameInstance;                               // 0x0520(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UOverlay*                               MainOverlay;                                       // 0x0528(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UCanvasPanel*                           InnerCanvasPanel;                                  // 0x0530(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	FMulticastInlineDelegateProperty_             OnRadialWheelContentInvoked;                       // 0x0538(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	TSubclassOf<class UVAL_RadialWheelSlotWidget> RadialWheelSlotWidgetClass;                        // 0x0548(0x0008)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoDestructor, Protected, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         Radius;                                            // 0x0550(0x0004)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	int32                                         NumRadialSlotsAroundCircle;                        // 0x0554(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	TSet<int32>                                   SkippedRadialSlotIndices;                          // 0x0558(0x0050)(Edit, BlueprintVisible, BlueprintReadOnly, Protected, NativeAccessSpecifierProtected)
	bool                                          bDisplayCenterSlot;                                // 0x05A8(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	uint8                                         Pad_2CF7[0x7];                                     // 0x05A9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UVAL_RadialWheelSlotWidget*>     RadialWheelSlotWidgets;                            // 0x05B0(0x0010)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, Transient, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	class UVAL_RadialWheelSlotWidget*             CenterSlotWidget;                                  // 0x05C0(0x0008)(BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
	class UVAL_RadialWheelSlotWidget*             LastSelectedSlotWidget;                            // 0x05C8(0x0008)(BlueprintVisible, ExportObject, ZeroConstructor, Transient, InstancedReference, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)

public:
	void BPNE_InitializeRadialWheel();
	void BPNE_ResetAnimatedProperties();
	void ClearRadialWheelContents();
	bool TryInvokeLastSelectedSlotWidgetContentAction();

	float ConvertAngleToStandardDegreeRange(float InAngle) const;
	const TArray<class UVAL_RadialWheelSlotWidget*> GetAllRadialWheelSlotWidgets() const;
	class UVAL_RadialWheelSlotWidget* GetCenterSlotWidget() const;
	class UVAL_RadialWheelSlotWidget* GetSlotWidgetAtAngle(float InAngle) const;
	class UVAL_RadialWheelSlotWidget* GetSlotWidgetAtIndex(int32 InIndex) const;
	bool IsAngleBetweenRange(float InAngle, float LowerBound, float UpperBound) const;

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"VAL_RadialWheelWidget">();
	}
	static class UVAL_RadialWheelWidget* GetDefaultObj()
	{
		return GetDefaultObjImpl<UVAL_RadialWheelWidget>();
	}
};
static_assert(alignof(UVAL_RadialWheelWidget) == 0x000008, "Wrong alignment on UVAL_RadialWheelWidget");
static_assert(sizeof(UVAL_RadialWheelWidget) == 0x0005D0, "Wrong size on UVAL_RadialWheelWidget");
static_assert(offsetof(UVAL_RadialWheelWidget, ValeriaGameInstance) == 0x000520, "Member 'UVAL_RadialWheelWidget::ValeriaGameInstance' has a wrong offset!");
static_assert(offsetof(UVAL_RadialWheelWidget, MainOverlay) == 0x000528, "Member 'UVAL_RadialWheelWidget::MainOverlay' has a wrong offset!");
static_assert(offsetof(UVAL_RadialWheelWidget, InnerCanvasPanel) == 0x000530, "Member 'UVAL_RadialWheelWidget::InnerCanvasPanel' has a wrong offset!");
static_assert(offsetof(UVAL_RadialWheelWidget, OnRadialWheelContentInvoked) == 0x000538, "Member 'UVAL_RadialWheelWidget::OnRadialWheelContentInvoked' has a wrong offset!");
static_assert(offsetof(UVAL_RadialWheelWidget, RadialWheelSlotWidgetClass) == 0x000548, "Member 'UVAL_RadialWheelWidget::RadialWheelSlotWidgetClass' has a wrong offset!");
static_assert(offsetof(UVAL_RadialWheelWidget, Radius) == 0x000550, "Member 'UVAL_RadialWheelWidget::Radius' has a wrong offset!");
static_assert(offsetof(UVAL_RadialWheelWidget, NumRadialSlotsAroundCircle) == 0x000554, "Member 'UVAL_RadialWheelWidget::NumRadialSlotsAroundCircle' has a wrong offset!");
static_assert(offsetof(UVAL_RadialWheelWidget, SkippedRadialSlotIndices) == 0x000558, "Member 'UVAL_RadialWheelWidget::SkippedRadialSlotIndices' has a wrong offset!");
static_assert(offsetof(UVAL_RadialWheelWidget, bDisplayCenterSlot) == 0x0005A8, "Member 'UVAL_RadialWheelWidget::bDisplayCenterSlot' has a wrong offset!");
static_assert(offsetof(UVAL_RadialWheelWidget, RadialWheelSlotWidgets) == 0x0005B0, "Member 'UVAL_RadialWheelWidget::RadialWheelSlotWidgets' has a wrong offset!");
static_assert(offsetof(UVAL_RadialWheelWidget, CenterSlotWidget) == 0x0005C0, "Member 'UVAL_RadialWheelWidget::CenterSlotWidget' has a wrong offset!");
static_assert(offsetof(UVAL_RadialWheelWidget, LastSelectedSlotWidget) == 0x0005C8, "Member 'UVAL_RadialWheelWidget::LastSelectedSlotWidget' has a wrong offset!");
