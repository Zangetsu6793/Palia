...
public:
	...
	uint8                                         Pad_1CFA[0x8];                                     // 0x0050(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1CFB[0x8];                                     // 0x0510(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1CFC[0x10];                                    // 0x0520(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1CFD[0x7];                                     // 0x0551(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void HandleInputAction_UIBack_Triggered(const struct FInputActionValue& ActionValue, float ElapsedTime, float TriggeredTime, const class UInputAction* SourceAction);
	void HandleOpened_BP();
	void HandleStartClosing_BP(const bool bPermitLatentClosing, bool* bOutHasLatentClosingLogic);
	...
	void SetWantsCursor(const bool bValue);
...
public:
	...
	uint8                                         Pad_1CFE[0x78];                                    // 0x0570(0x0078)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1CFF[0x10];                                    // 0x0198(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D00[0x5];                                     // 0x01AB(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D01[0x6];                                     // 0x01DA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D02[0x7];                                     // 0x01F1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D03[0x8];                                     // 0x0258(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D04[0x20];                                    // 0x0280(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void ActiveNavigationGroup(const bool bDelayActive, const int32 InAutoSelectNavWidgetID);
	void AddNavExplicitData(const struct FS6UI_NavExplicitData& InNavExplicitData);
	void AddNavigationGroupTransitionData(const struct FS6UI_NavigationGroupTranstionData& InTransitionData, const bool bInBidirectional, const bool bClearMatchingGroupNavigations);
	void AddNavWidgets(const TArray<class UWidget*>& InWidgetArray, bool bInBuildNavigationImmediately);
	void BuildNavigation(const bool bInImmediately);
	void ClearNavigationData(const bool bInClearNavWidgets);
	void ClearNavigationGroupTransitionDatas();
	void DelayExcuteNavigationFromParentGroup(const struct FFocusEvent& InFocusEvent);
	void EnableAutoEdgeEscape(const bool bInAutoEdgeEscape);
	void ExcuteNavigationFromParentGroup();
	void NavigateToTargetWidget(const int32 InTargetWidgetIndex, const bool bDelayActive);
	void OnCustomNavigationGroupInitialized__DelegateSignature(const class US6UI_CustomNavigationGroup* NavGroup);
	bool OnCustomNavigationGroupTransitionEvent__DelegateSignature(const EUINavigation InNavigationType, class US6UI_CustomNavigationGroup* InOriginNavigationGroup, const int32 InOriginWidgetIndex, const int32 InTargetWidgetIndex);
	void OnGroupEnableChanged__DelegateSignature(const class US6UI_CustomNavigationGroup* InNavGroup, const bool InbIsEnabled);
	bool OnIsWidgetValiedToNavigate__DelegateSignature(const class UObject* NavObject);
	void OnNavigated__DelegateSignature(const class US6UI_CustomNavigationGroup* NavGroup);
	void SetAutoEdgeEscapeDirections(const TArray<EUINavigation>& InEdgeEscapeDirections);
...
public:
	...
	uint8                                         Pad_1D0D[0x2];                                     // 0x002A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	struct FGuid RegisterInputActionBinding(class UInputAction* InputAction, const ETriggerEvent TriggerEventType, const TDelegate<void(const struct FInputActionValue& ActionValue, float ElapsedTime, float TriggeredTime, class UInputAction* SourceAction)>& Delegate);
	void SetIsEnabled(const bool bValue);
	void UnregisterInputActionBinding(const struct FGuid& BindingId);
...
{
public:
	uint8                                         Pad_1D10[0x70];                                    // 0x0030(0x0070)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1D11[0x150];                                   // 0x00B0(0x0150)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	void UpdateToolTipText(const class FText& Text);
...
public:
	static class US6UI_UIManagerWidgetBase* GetUIManagerWidget(const class APlayerController* PC);

	void ActivateModalWidget(const class UWidget* Widget);
	void AddLoadingScreenWidget(class UUserWidget* Widget);
	void CloseModalWidget(const class UWidget* Widget, const bool bShouldForceClose, const bool bPermitLatentClosing);
	bool CloseTopModalWidget(const bool bShouldForceClose, const bool bPermitLatentClosing);
	void CreateDefaultStateWidget();
	void DeactivateModalWidget(const class UWidget* Widget);
	...
	void OpenModalWidget(const class UWidget* Widget);
...
class US6UI_UIManagerCrossPlatformHelper final : public UObject
{
public:
...
public:
	...
	static void DismissContextMenu(const struct FS6UI_ContextMenu& ContextMenu);
	...
	static class UUserWidget* GetContextMenuContentWidget(const struct FS6UI_ContextMenu& ContextMenu);
	...
	static bool SummonContextMenu(class UObject* WorldContextObject, const struct FPointerEvent& MouseEvent, const TSubclassOf<class UUserWidget>& ContentWidgetClass, struct FS6UI_ContextMenu& OutContextMenu);
	static bool SummonContextMenuAtPosition(class UObject* WorldContextObject, class UWidget* ParentWidget, const struct FVector2D& Position, const TSubclassOf<class UUserWidget>& ContentWidgetClass, struct FS6UI_ContextMenu& OutContextMenu);
