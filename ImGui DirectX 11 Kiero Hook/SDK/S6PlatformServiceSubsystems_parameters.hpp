...
{
public:
	struct FS6PLAT_PlayerBehaviorReportForm       ReportForm;                                        // 0x0000(0x00C8)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
...
static_assert(sizeof(S6PLAT_PlayerBehaviorSubsystem_ReportPlayerBehavior) == 0x0000C8, "Wrong size on S6PLAT_PlayerBehaviorSubsystem_ReportPlayerBehavior");
...
public:
	...
	struct FS6PLAT_PlayerBehaviorReportForm       ReportForm;                                        // 0x0008(0x00C8)(ConstParm, Parm, NativeAccessSpecifierPublic)
	bool                                          bDidSucceed;                                       // 0x00D0(0x0001)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2C24[0x7];                                     // 0x00D1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(S6PLAT_PlayerBehaviorSubsystem_ReportSubmitedDelegate__DelegateSignature) == 0x0000D8, "Wrong size on S6PLAT_PlayerBehaviorSubsystem_ReportSubmitedDelegate__DelegateSignature");
...
static_assert(offsetof(S6PLAT_PlayerBehaviorSubsystem_ReportSubmitedDelegate__DelegateSignature, bDidSucceed) == 0x0000D0, "Member 'S6PLAT_PlayerBehaviorSubsystem_ReportSubmitedDelegate__DelegateSignature::bDidSucceed' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_2C25[0x7];                                     // 0x00C9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
static_assert(sizeof(S6PLAT_PlayerBehaviorSubsystem_ValidateReportForm) == 0x0000D0, "Wrong size on S6PLAT_PlayerBehaviorSubsystem_ValidateReportForm");
...
static_assert(offsetof(S6PLAT_PlayerBehaviorSubsystem_ValidateReportForm, ReturnValue) == 0x0000C8, "Member 'S6PLAT_PlayerBehaviorSubsystem_ValidateReportForm::ReturnValue' has a wrong offset!");
