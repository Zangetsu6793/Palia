...
public:
	...
	uint8                                         Pad_1CD7[0x16];                                    // 0x04B2(0x0016)(Fixing Size After Last Property [ Dumper-7 ])
...
class UCommonButtonBaseInputExtended final : public UCommonButtonBase
{
public:
	static class UClass* StaticClass()
	{
...
class UCommonUserWidgetInputExtended final : public UCommonUserWidget
{
public:
	...
	uint8                                         Pad_1CD8[0x16];                                    // 0x038A(0x0016)(Fixing Struct Size After Last Property [ Dumper-7 ])
