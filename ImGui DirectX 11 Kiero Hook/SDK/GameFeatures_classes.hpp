...
public:
	...
	uint8                                         Pad_2D59[0xF];                                     // 0x0039(0x000F)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2D5A[0x8];                                     // 0x0058(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2D5B[0x50];                                    // 0x0038(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2D5C[0x10];                                    // 0x0030(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2D5D[0x7];                                     // 0x0039(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	bool                                          bPreloadInEditor;                                  // 0x0038(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2D5E[0x7];                                     // 0x0039(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2D5F[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameFeaturePluginStateMachineProperties StateProperties;                                   // 0x0030(0x00C8)(Transient, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2D60[0xF0];                                    // 0x00F8(0x00F0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2D61[0xA0];                                    // 0x0090(0x00A0)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2D62[0x8];                                     // 0x0148(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2D63[0x20];                                    // 0x0088(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
