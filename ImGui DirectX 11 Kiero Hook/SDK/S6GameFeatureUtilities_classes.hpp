...
public:
	...
	uint8                                         Pad_32D1[0x8];                                     // 0x00F0(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	void OnAssetsRegistered__DelegateSignature(class US6GenericAssetRegistryInstance* RegistryInstance, const TSet<TSoftObjectPtr<class UObject>>& Assets);
	void OnAssetsUnregistered__DelegateSignature(class US6GenericAssetRegistryInstance* RegistryInstance, const TSet<TSoftObjectPtr<class UObject>>& Assets);
	void RegisterAssets(const TSet<TSoftObjectPtr<class UObject>>& Assets);
	void UnregisterAssets(const TSet<TSoftObjectPtr<class UObject>>& Assets);
