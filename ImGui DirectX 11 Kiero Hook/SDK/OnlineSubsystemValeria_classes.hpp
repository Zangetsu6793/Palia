...
public:
	...
	float                                         SecondsOfRefreshTokenInAdvance;                    // 0x0040(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1AA8[0x4];                                     // 0x0044(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 AuthenticationEndpointUrl;                         // 0x0048(0x0010)(ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 AuthenticationApplicationId;                       // 0x0058(0x0010)(ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 AuthenticationSecretKey;                           // 0x0068(0x0010)(ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AuthTokenRetry_BaseIntervalSeconds;                // 0x0078(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         AuthTokenRetry_MaximumIntervalSansJitterSeconds;   // 0x007C(0x0004)(Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FText                                   LoginGenericErrorText;                             // 0x0080(0x0018)(Edit, BlueprintVisible, Config, NativeAccessSpecifierPublic)
	class FText                                   LoginAccessNotEligibleText;                        // 0x0098(0x0018)(Edit, BlueprintVisible, Config, NativeAccessSpecifierPublic)
	class FText                                   LoginAccessOfflineText;                            // 0x00B0(0x0018)(Edit, BlueprintVisible, Config, NativeAccessSpecifierPublic)
	class FText                                   LoginAccountInfoMissingText;                       // 0x00C8(0x0018)(Edit, BlueprintVisible, Config, NativeAccessSpecifierPublic)
	class FText                                   LoginPasswordEmptyText;                            // 0x00E0(0x0018)(Edit, BlueprintVisible, Config, NativeAccessSpecifierPublic)
	class FText                                   LoginPasswordResetText;                            // 0x00F8(0x0018)(Edit, BlueprintVisible, Config, NativeAccessSpecifierPublic)
	class FText                                   LoginSystemOverwhelmedText;                        // 0x0110(0x0018)(Edit, BlueprintVisible, Config, NativeAccessSpecifierPublic)
	class FText                                   LoginCredentialErrorText;                          // 0x0128(0x0018)(Edit, BlueprintVisible, Config, NativeAccessSpecifierPublic)
	class FText                                   LoginAccountLockedText;                            // 0x0140(0x0018)(Edit, BlueprintVisible, Config, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UOSSVAL_IdentitySettings) == 0x000158, "Wrong size on UOSSVAL_IdentitySettings");
...
static_assert(offsetof(UOSSVAL_IdentitySettings, SecondsOfRefreshTokenInAdvance) == 0x000040, "Member 'UOSSVAL_IdentitySettings::SecondsOfRefreshTokenInAdvance' has a wrong offset!");
static_assert(offsetof(UOSSVAL_IdentitySettings, AuthenticationEndpointUrl) == 0x000048, "Member 'UOSSVAL_IdentitySettings::AuthenticationEndpointUrl' has a wrong offset!");
static_assert(offsetof(UOSSVAL_IdentitySettings, AuthenticationApplicationId) == 0x000058, "Member 'UOSSVAL_IdentitySettings::AuthenticationApplicationId' has a wrong offset!");
static_assert(offsetof(UOSSVAL_IdentitySettings, AuthenticationSecretKey) == 0x000068, "Member 'UOSSVAL_IdentitySettings::AuthenticationSecretKey' has a wrong offset!");
static_assert(offsetof(UOSSVAL_IdentitySettings, AuthTokenRetry_BaseIntervalSeconds) == 0x000078, "Member 'UOSSVAL_IdentitySettings::AuthTokenRetry_BaseIntervalSeconds' has a wrong offset!");
static_assert(offsetof(UOSSVAL_IdentitySettings, AuthTokenRetry_MaximumIntervalSansJitterSeconds) == 0x00007C, "Member 'UOSSVAL_IdentitySettings::AuthTokenRetry_MaximumIntervalSansJitterSeconds' has a wrong offset!");
static_assert(offsetof(UOSSVAL_IdentitySettings, LoginGenericErrorText) == 0x000080, "Member 'UOSSVAL_IdentitySettings::LoginGenericErrorText' has a wrong offset!");
static_assert(offsetof(UOSSVAL_IdentitySettings, LoginAccessNotEligibleText) == 0x000098, "Member 'UOSSVAL_IdentitySettings::LoginAccessNotEligibleText' has a wrong offset!");
static_assert(offsetof(UOSSVAL_IdentitySettings, LoginAccessOfflineText) == 0x0000B0, "Member 'UOSSVAL_IdentitySettings::LoginAccessOfflineText' has a wrong offset!");
static_assert(offsetof(UOSSVAL_IdentitySettings, LoginAccountInfoMissingText) == 0x0000C8, "Member 'UOSSVAL_IdentitySettings::LoginAccountInfoMissingText' has a wrong offset!");
static_assert(offsetof(UOSSVAL_IdentitySettings, LoginPasswordEmptyText) == 0x0000E0, "Member 'UOSSVAL_IdentitySettings::LoginPasswordEmptyText' has a wrong offset!");
static_assert(offsetof(UOSSVAL_IdentitySettings, LoginPasswordResetText) == 0x0000F8, "Member 'UOSSVAL_IdentitySettings::LoginPasswordResetText' has a wrong offset!");
static_assert(offsetof(UOSSVAL_IdentitySettings, LoginSystemOverwhelmedText) == 0x000110, "Member 'UOSSVAL_IdentitySettings::LoginSystemOverwhelmedText' has a wrong offset!");
static_assert(offsetof(UOSSVAL_IdentitySettings, LoginCredentialErrorText) == 0x000128, "Member 'UOSSVAL_IdentitySettings::LoginCredentialErrorText' has a wrong offset!");
static_assert(offsetof(UOSSVAL_IdentitySettings, LoginAccountLockedText) == 0x000140, "Member 'UOSSVAL_IdentitySettings::LoginAccountLockedText' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1AA9[0x18];                                    // 0x0050(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UOSSVAL_GetCharacterNamesByAccountIdProxy* GetCharacterNamesByAccountId(class UObject* WorldContextObject, const struct FGuid& AccountId);

	void OnGetCharacterNames_Fail__DelegateSignature(const struct FGuid& AccountId);
	void OnGetCharacterNames_Success__DelegateSignature(const struct FGuid& AccountId, const TArray<struct FOSSVAL_CharacterNameAndId>& Names);
...
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_1AAA[0x28];                                    // 0x0050(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UOSSVAL_GetCharacterNameByAccountIdAndCharacterIdProxy* GetCharacterNameByAccountIdAndCharacterId(class UObject* WorldContextObject, const struct FGuid& AccountId, const struct FGuid& CharacterId);

	void OnGetCharacterNames_Fail__DelegateSignature(const struct FGuid& AccountId, const struct FGuid& CharacterId);
	void OnGetCharacterNames_Success__DelegateSignature(const struct FGuid& AccountId, const struct FGuid& CharacterId, const struct FOSSVAL_CharacterNameAndId& Param_Name);
...
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_1AAB[0x18];                                    // 0x0050(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UOSSVAL_GetCharacterNameByCharacterIdProxy* GetCharacterNameByCharacterId(class UObject* WorldContextObject, const struct FGuid& CharacterId);

	void OnFetchCharacter_Failure__DelegateSignature(const struct FGuid& CharacterId);
	void OnFetchCharacter_Success__DelegateSignature(const struct FGuid& CharacterId, const struct FOSSVAL_CharacterNameAndId& FetchedCharacter);
...
public:
	FMulticastInlineDelegateProperty_             OnSuccess;                                         // 0x0030(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnFailure;                                         // 0x0040(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_1AAC[0x18];                                    // 0x0050(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UOSSVAL_GetNetIdByCharacterIdProxy* GetNetIdByCharacterId(class UObject* WorldContextObject, const struct FGuid& CharacterId);

	void OnFetchNetId_Failure__DelegateSignature(const struct FGuid& CharacterId);
	void OnFetchNetId_Success__DelegateSignature(const struct FGuid& CharacterId, const struct FUniqueNetIdRepl& FetchedNetId);
...
public:
	...
	uint8                                         Pad_1AAD[0x18];                                    // 0x0050(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	static class UOSSVAL_AsyncActionGetCharactersByAccountId* GetCharactersByAccountId(class ULocalPlayer* LocalPlayer, const struct FGuid& ID);

	void OnGetCharactersFailed__DelegateSignature();
	void OnGetCharactersObtained__DelegateSignature(const TArray<struct FVALDTOS_MetaCharacterFormat>& CharactersFound);
...
public:
	...
	uint8                                         Pad_1AAE[0x20];                                    // 0x0040(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	static class UOSSVAL_AsyncActionProfanityFilterString* FilterStringViaChat(class ULocalPlayer* LocalPlayer, const class FString& Str);

	void OnResultObtained__DelegateSignature(const struct FOSSVAL_ProfanityFilterResponse& Response);
...
static_assert(sizeof(UOSSVAL_AsyncActionProfanityFilterString) == 0x000060, "Wrong size on UOSSVAL_AsyncActionProfanityFilterString");
...
public:
	...
	uint8                                         Pad_1AAF[0x8];                                     // 0x0040(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1AB1[0x20];                                    // 0x0338(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void RpcClient_SendTicketValidationResponse(const struct FGuid& RequestID, const bool bAccepted, const struct FOSSVAL_MatchmakingTicket& Ticket, const struct FOSSVAL_MatchmakingTicketContext& Context);
	void RpcServer_ValidateTicket(const struct FGuid& RequestID, const struct FOSSVAL_MatchmakingTicket& Ticket, const struct FOSSVAL_MatchmakingTicketContext& Context);
...
{
public:
	uint8                                         Pad_1AB3[0x48];                                    // 0x02D0(0x0048)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	static bool TryGetStagingAuthArgs(class FString* OutEndPoint, class FString* OutSecretKey, class FString* OutAppId);
...
public:
	...
	uint8                                         Pad_1AB5[0xA8];                                    // 0x0090(0x00A8)(Fixing Struct Size After Last Property [ Dumper-7 ])
